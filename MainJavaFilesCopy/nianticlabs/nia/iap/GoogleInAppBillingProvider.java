...
public class GoogleInAppBillingProvider implements InAppBillingProvider {
    ...
    class C07581 implements ServiceConnection {
        ...
        class C07572 implements Runnable {
            C07572() {
            }
        ...
        public void onServiceConnected(ComponentName componentName, IBinder iBinder) {
            ContextService.runOnServiceHandler(new C07561(iBinder));
        }

        public void onServiceDisconnected(ComponentName componentName) {
            ContextService.runOnServiceHandler(new C07572());
        }
    }
    ...
    class C07603 implements Runnable {
        ...
        C07603(int i, int i2, String str, String str2) {
    ...
    private class ProcessPurchasedItemsTask extends AsyncTask<Void, Void, Bundle> {
        ...
        L_0x0006:
            ...
            r3 = r1;
        L_0x0009:
            r4 = r8.billingService;	 Catch:{ RemoteException -> 0x0073 }
            r5 = 3;
            r6 = com.nianticlabs.nia.iap.GoogleInAppBillingProvider.this;	 Catch:{ RemoteException -> 0x0073 }
            r6 = r6.packageName;	 Catch:{ RemoteException -> 0x0073 }
            r7 = "inapp";
            r5 = r4.getPurchases(r5, r6, r7, r0);	 Catch:{ RemoteException -> 0x0073 }
            r6 = com.nianticlabs.nia.iap.GoogleInAppBillingProvider.getResponseCodeFromBundle(r5);	 Catch:{ RemoteException -> 0x0073 }
            r0 = "INAPP_PURCHASE_DATA_LIST";
            r0 = r5.getStringArrayList(r0);	 Catch:{ RemoteException -> 0x0073 }
            r4 = "INAPP_DATA_SIGNATURE_LIST";
            r4 = r5.getStringArrayList(r4);	 Catch:{ RemoteException -> 0x0073 }
            r7 = 5;
        ...
        L_0x003f:
            ...
            r6 = r5.containsKey(r6);	 Catch:{ RemoteException -> 0x0073 }
            if (r6 == 0) goto L_0x002b;
        L_0x0047:
            ...
            if (r6 == 0) goto L_0x002b;
        L_0x004f:
            r6 = r0.size();	 Catch:{ RemoteException -> 0x0073 }
            r7 = r4.size();	 Catch:{ RemoteException -> 0x0073 }
        ...
        L_0x005d:
            ...
            r0 = r5.getString(r0);	 Catch:{ RemoteException -> 0x0073 }
            if (r0 == 0) goto L_0x002b;
        L_0x0065:
            r4 = r0.length();	 Catch:{ RemoteException -> 0x0073 }
            if (r4 != 0) goto L_0x0009;
        L_0x006b:
            goto L_0x002b;
        L_0x006c:
            r2.addAll(r0);	 Catch:{ RemoteException -> 0x0073 }
            r3.addAll(r4);	 Catch:{ RemoteException -> 0x0073 }
            goto L_0x005d;
        L_0x0073:
            r0 = move-exception;
            goto L_0x002b;
        ...
        protected void onPostExecute(Bundle bundle) {
            if (bundle != null) {
                ContextService.runOnServiceHandler(new C07611(bundle));
                return;
            }
            GoogleInAppBillingProvider.this.finalizeConnectionResult();
            GoogleInAppBillingProvider.this.maybeDisconnectBillingService();
    ...
    private void connectToBillingService() {
        if (!this.connectionInProgress) {
            ...
            this.serviceConnection = new C07581();
            Intent intent = new Intent("com.android.vending.billing.InAppBillingService.BIND");
            intent.setPackage(GooglePlayServicesUtil.GOOGLE_PLAY_STORE_PACKAGE);
            List queryIntentServices = this.context.getPackageManager().queryIntentServices(intent, BILLING_RESPONSE_RESULT_OK);
    ...
    private void launchPurchaseActivity(PendingIntent pendingIntent) {
        ...
        ContextService.runOnUiThread(new C07592());
    }
    ...
    public void forwardedOnActivityResult(int i, Intent intent) {
        ...
        ContextService.runOnServiceHandler(new C07603(i, responseCodeFromIntent, stringExtra, str));
    }
