...
public class GoogleUnityActivity extends Activity {
    ...
    class C07131 implements OnTouchListener {
        C07131() {
        }
    ...
    class C07142 implements OnGenericMotionListener {
        C07142() {
        }
    ...
    class C07153 implements OnKeyListener {
        C07153() {
        }
    ...
    class C07185 implements OnSystemUiVisibilityChangeListener {
        ...
        C07185(Handler handler) {
            this.val$handler = handler;
        }

        public void onSystemUiVisibilityChange(int i) {
            if ((i & 2) == 0) {
                this.val$handler.postDelayed(new C07171(), 2000);
            }
    ...
    private void startImmersiveMode() {
        getWindow().getDecorView().setOnSystemUiVisibilityChangeListener(new C07185(new Handler()));
    }
    ...
    protected void onCreate(Bundle bundle) {
        ...
        this.mUnityPlayer.setOnTouchListener(new C07131());
        this.mUnityPlayer.setOnGenericMotionListener(new C07142());
        this.mUnityPlayer.setOnKeyListener(new C07153());
    ...
    public void showAndroidViewLayer(int i) {
        runOnUiThread(new C07164(this, i));
    }
}
