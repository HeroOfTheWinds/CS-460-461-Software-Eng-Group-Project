...
public final class zzk implements Callback {
    ...
    L_0x000f:
        ...
        r3 = r5.zzpd;
        monitor-enter(r3);
        r0 = r5.zzafV;	 Catch:{ all -> 0x007a }
        if (r0 != 0) goto L_0x007f;
    L_0x001b:
        r0 = r1;
    L_0x001c:
        com.google.android.gms.common.internal.zzx.zzZ(r0);	 Catch:{ all -> 0x007a }
        r0 = r5.mHandler;	 Catch:{ all -> 0x007a }
        r4 = 1;
        r0.removeMessages(r4);	 Catch:{ all -> 0x007a }
        r0 = 1;
        r5.zzafV = r0;	 Catch:{ all -> 0x007a }
        r0 = r5.zzafR;	 Catch:{ all -> 0x007a }
        r0 = r0.size();	 Catch:{ all -> 0x007a }
        if (r0 != 0) goto L_0x0081;
    L_0x0030:
        com.google.android.gms.common.internal.zzx.zzZ(r1);	 Catch:{ all -> 0x007a }
        r0 = new java.util.ArrayList;	 Catch:{ all -> 0x007a }
        r1 = r5.zzafQ;	 Catch:{ all -> 0x007a }
        r0.<init>(r1);	 Catch:{ all -> 0x007a }
        r1 = r5.zzafU;	 Catch:{ all -> 0x007a }
        r1 = r1.get();	 Catch:{ all -> 0x007a }
        r2 = r0.iterator();	 Catch:{ all -> 0x007a }
    L_0x0044:
        r0 = r2.hasNext();	 Catch:{ all -> 0x007a }
        if (r0 == 0) goto L_0x0064;
    L_0x004a:
        r0 = r2.next();	 Catch:{ all -> 0x007a }
        r0 = (com.google.android.gms.common.api.GoogleApiClient.ConnectionCallbacks) r0;	 Catch:{ all -> 0x007a }
        r4 = r5.zzafT;	 Catch:{ all -> 0x007a }
        if (r4 == 0) goto L_0x0064;
    L_0x0054:
        r4 = r5.zzafP;	 Catch:{ all -> 0x007a }
        r4 = r4.isConnected();	 Catch:{ all -> 0x007a }
        if (r4 == 0) goto L_0x0064;
    L_0x005c:
        r4 = r5.zzafU;	 Catch:{ all -> 0x007a }
    ...
    L_0x0064:
        ...
        return;
    L_0x006e:
        r4 = r5.zzafR;	 Catch:{ all -> 0x007a }
        r4 = r4.contains(r0);	 Catch:{ all -> 0x007a }
        if (r4 != 0) goto L_0x0044;
    L_0x0076:
        r0.onConnected(r6);	 Catch:{ all -> 0x007a }
        goto L_0x0044;
    L_0x007a:
        r0 = move-exception;
        monitor-exit(r3);	 Catch:{ all -> 0x007a }
