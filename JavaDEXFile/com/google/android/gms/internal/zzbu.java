...
public abstract class zzbu<T> {
    ...
    static final class C04641 extends zzbu<Boolean> {
        C04641(String str, Boolean bool) {
            super(bool, null);
        }
    ...
    static final class C04652 extends zzbu<Integer> {
        C04652(String str, Integer num) {
            super(num, null);
        }
    ...
    static final class C04663 extends zzbu<Long> {
        C04663(String str, Long l) {
            super(l, null);
        }
    ...
    static final class C04674 extends zzbu<String> {
        C04674(String str, String str2) {
            super(str2, null);
        }
