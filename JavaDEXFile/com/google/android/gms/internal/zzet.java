    ...
    public void zza(AdRequestParcel adRequestParcel, String str) throws RemoteException {
        ...
        if (this.zzzJ instanceof MediationRewardedVideoAdAdapter) {
            ...
            try {
                ...
                MediationAdRequest com_google_android_gms_internal_zzes = new zzes(adRequestParcel.zzsB == -1 ? null : new Date(adRequestParcel.zzsB), adRequestParcel.zzsC, adRequestParcel.zzsD != null ? new HashSet(adRequestParcel.zzsD) : null, adRequestParcel.zzsJ, adRequestParcel.zzsE, adRequestParcel.zzsF);
                if (adRequestParcel.zzsL != null) {
                    bundle = adRequestParcel.zzsL.getBundle(mediationRewardedVideoAdAdapter.getClass().getName());
                }
                mediationRewardedVideoAdAdapter.loadAd(com_google_android_gms_internal_zzes, zza(str, adRequestParcel.zzsF, null), bundle);
            } catch (Throwable th) {
