...
public class zzfb extends zzfh {
    ...
    class C05181 implements OnClickListener {
        final /* synthetic */ zzfb zzAa;

        C05181(zzfb com_google_android_gms_internal_zzfb) {
    ...
    class C05192 implements OnClickListener {
        final /* synthetic */ zzfb zzAa;

        C05192(zzfb com_google_android_gms_internal_zzfb) {
            this.zzAa = com_google_android_gms_internal_zzfb;
        }
    ...
    public void execute() {
        if (this.mContext == null) {
            ...
            zzK.setTitle(zzp.zzby().zzd(C0148R.string.create_calendar_title, "Create calendar event"));
            zzK.setMessage(zzp.zzby().zzd(C0148R.string.create_calendar_message, "Allow Ad to create a calendar event?"));
            zzK.setPositiveButton(zzp.zzby().zzd(C0148R.string.accept, "Accept"), new C05181(this));
            zzK.setNegativeButton(zzp.zzby().zzd(C0148R.string.decline, "Decline"), new C05192(this));
            zzK.create().show();
        } else {
