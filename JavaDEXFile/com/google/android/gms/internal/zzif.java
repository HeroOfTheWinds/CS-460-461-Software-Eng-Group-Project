...
public class zzif {
    ...
    class C05621 implements OnClickListener {
        ...
        C05621(zzif com_google_android_gms_internal_zzif, String str) {
    ...
    class C05632 implements OnClickListener {
        ...
        C05632(zzif com_google_android_gms_internal_zzif) {
            this.zzIN = com_google_android_gms_internal_zzif;
        }
    ...
    private void showDialog() {
        if (this.mContext instanceof Activity) {
            ...
            builder.setPositiveButton("Share", new C05621(this, zzaD));
            builder.setNegativeButton("Close", new C05632(this));
            builder.create().show();
            return;
        }
