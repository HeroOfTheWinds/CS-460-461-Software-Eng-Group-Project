...
public class zzih {
    ...
    static final class C05651 implements zza {
        C05651() {
        }
    ...
    class C05662 implements com.google.android.gms.internal.zzm.zza {
        final /* synthetic */ zzc zzJb;
        final /* synthetic */ zzih zzJc;
        final /* synthetic */ String zzyc;

        C05662(zzih com_google_android_gms_internal_zzih, String str, zzc com_google_android_gms_internal_zzih_zzc) {
    ...
    class C05673 extends zzab {
        final /* synthetic */ zzih zzJc;
        final /* synthetic */ Map zzJd;

        C05673(zzih com_google_android_gms_internal_zzih, String str, com.google.android.gms.internal.zzm.zzb com_google_android_gms_internal_zzm_zzb, com.google.android.gms.internal.zzm.zza com_google_android_gms_internal_zzm_zza, Map map) {
            this.zzJc = com_google_android_gms_internal_zzih;
            this.zzJd = map;
    ...
    private static class zzb<T> extends zzk<InputStream> {
        ...
        class C05681 implements com.google.android.gms.internal.zzm.zza {
            final /* synthetic */ com.google.android.gms.internal.zzm.zzb zzJf;
            final /* synthetic */ zza zzJg;

            C05681(com.google.android.gms.internal.zzm.zzb com_google_android_gms_internal_zzm_zzb, zza com_google_android_gms_internal_zzih_zza) {
        ...
        public zzb(String str, zza<T> com_google_android_gms_internal_zzih_zza_T, com.google.android.gms.internal.zzm.zzb<T> com_google_android_gms_internal_zzm_zzb_T) {
            super(0, str, new C05681(com_google_android_gms_internal_zzm_zzb_T, com_google_android_gms_internal_zzih_zza_T));
    ...
    public zziq<String> zza(String str, Map<String, String> map) {
        Object com_google_android_gms_internal_zzih_zzc = new zzc();
        zzIZ.zze(new C05673(this, str, com_google_android_gms_internal_zzih_zzc, new C05662(this, str, com_google_android_gms_internal_zzih_zzc), map));
        return com_google_android_gms_internal_zzih_zzc;
    }
}
