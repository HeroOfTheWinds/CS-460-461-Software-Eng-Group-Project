...
public class zzbk extends Thread {
    ...
    class C04591 implements Runnable {
        ...
        C04591(zzbk com_google_android_gms_internal_zzbk, View view) {
    ...
    class C04612 implements Runnable {
        ...
        class C04601 implements ValueCallback<String> {
            final /* synthetic */ C04612 zzsl;

            C04601(C04612 c04612) {
                this.zzsl = c04612;
            }
        ...
        C04612(zzbk com_google_android_gms_internal_zzbk, zzbh com_google_android_gms_internal_zzbh, WebView webView) {
            this.zzsh = com_google_android_gms_internal_zzbk;
            this.zzsj = com_google_android_gms_internal_zzbh;
            this.zzsk = webView;
            this.zzsi = new C04601(this);
        }
    ...
    zza zza(View view, zzbh com_google_android_gms_internal_zzbh) {
        ...
        if ((view instanceof TextView) && !(view instanceof EditText)) {
            ...
            for (int i3 = 0; i3 < viewGroup.getChildCount(); i3++) {
                zza zza = zza(viewGroup.getChildAt(i3), com_google_android_gms_internal_zzbh);
                i += zza.zzsm;
                i2 += zza.zzsn;
            }
    ...
    boolean zza(WebView webView, zzbh com_google_android_gms_internal_zzbh) {
        ...
        com_google_android_gms_internal_zzbh.zzcp();
        webView.post(new C04612(this, com_google_android_gms_internal_zzbh, webView));
        return true;
    }
    ...
    boolean zzf(View view) {
        ...
        view.post(new C04591(this, view));
        return true;
    }
