...
public class zzdl implements zzdk {
    ...
    class C04831 implements Runnable {
        ...
        class C04821 implements Runnable {
            ...
            final /* synthetic */ C04831 zzxE;

            C04821(C04831 c04831, JSONObject jSONObject) {
                this.zzxE = c04831;
        ...
        C04831(zzdl com_google_android_gms_internal_zzdl, Map map, zziz com_google_android_gms_internal_zziz) {
        ...
        public void run() {
            ...
            if (zzX == null) {
                ...
                zzid.zzIE.post(new C04821(this, zzX));
            }
        }
    }
    ...
    public void zza(zziz com_google_android_gms_internal_zziz, Map<String, String> map) {
        zzic.zza(new C04831(this, map, com_google_android_gms_internal_zziz));
    }
