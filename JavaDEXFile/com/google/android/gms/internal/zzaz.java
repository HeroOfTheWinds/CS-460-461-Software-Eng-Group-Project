...
public class zzaz implements OnGlobalLayoutListener, OnScrollChangedListener {
    ...
    class C04421 implements zzc<zzbe> {
        final /* synthetic */ JSONObject zzrv;
        final /* synthetic */ zzaz zzrw;

        C04421(zzaz com_google_android_gms_internal_zzaz, JSONObject jSONObject) {
    ...
    class C04432 implements zza {
        ...
        C04432(zzaz com_google_android_gms_internal_zzaz) {
            this.zzrw = com_google_android_gms_internal_zzaz;
        }
    ...
    class C04443 implements zzc<zzbe> {
        final /* synthetic */ zzaz zzrw;

        C04443(zzaz com_google_android_gms_internal_zzaz) {
            this.zzrw = com_google_android_gms_internal_zzaz;
        }
    ...
    class C04454 implements zza {
        final /* synthetic */ zzaz zzrw;

        C04454(zzaz com_google_android_gms_internal_zzaz) {
            this.zzrw = com_google_android_gms_internal_zzaz;
        }
    ...
    class C04465 extends BroadcastReceiver {
        final /* synthetic */ zzaz zzrw;

        C04465(zzaz com_google_android_gms_internal_zzaz) {
            this.zzrw = com_google_android_gms_internal_zzaz;
        }
    ...
    class C04476 implements zzdk {
        final /* synthetic */ zzaz zzrw;

        C04476(zzaz com_google_android_gms_internal_zzaz) {
            this.zzrw = com_google_android_gms_internal_zzaz;
        }
    ...
    class C04487 implements zzdk {
        final /* synthetic */ zzaz zzrw;

        C04487(zzaz com_google_android_gms_internal_zzaz) {
            this.zzrw = com_google_android_gms_internal_zzaz;
        }
    ...
    class C04498 implements zzdk {
        final /* synthetic */ zzaz zzrw;

        C04498(zzaz com_google_android_gms_internal_zzaz) {
            this.zzrw = com_google_android_gms_internal_zzaz;
        }
    ...
    class C04509 implements zzc<zzbe> {
        final /* synthetic */ zzaz zzrw;
        final /* synthetic */ JSONObject zzrx;

        C04509(zzaz com_google_android_gms_internal_zzaz, JSONObject jSONObject) {
            this.zzrw = com_google_android_gms_internal_zzaz;
    ...
    public zzaz(AdSizeParcel adSizeParcel, zzhs com_google_android_gms_internal_zzhs, VersionInfoParcel versionInfoParcel, View view, zzdz com_google_android_gms_internal_zzdz) {
        ...
        this.zzrs = new C04476(this);
        this.zzrt = new C04487(this);
        this.zzru = new C04498(this);
        ...
        try {
            this.zzrg.zza(new C04421(this, zzd(view)), new C04432(this));
        } catch (JSONException e) {
        } catch (Throwable e2) {
            zzb.zzb("Failure while processing active view data.", e2);
        }
        this.zzrg.zza(new C04443(this), new C04454(this));
    ...
    protected void zza(JSONObject jSONObject) {
        try {
            ...
            this.zzrg.zza(new C04509(this, jSONObject2), new zzis.zzb());
        } catch (Throwable th) {
