...
public final class zzgv {
    ...
    class C05431 implements zzdk {
        final /* synthetic */ zzgv zzFT;

        C05431(zzgv com_google_android_gms_internal_zzgv) {
    ...
    class C05442 implements zzdk {
        final /* synthetic */ zzgv zzFT;

        C05442(zzgv com_google_android_gms_internal_zzgv) {
            this.zzFT = com_google_android_gms_internal_zzgv;
        }
    ...
    public zzgv(String str, String str2) {
        ...
        this.zzFP = new zzin();
        this.zzFR = new C05431(this);
        this.zzFS = new C05442(this);
        this.zzFO = str2;
        this.zzBY = str;
    }
