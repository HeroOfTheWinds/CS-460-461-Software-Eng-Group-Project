...
public class zzhg extends zzb implements zzhk {
    ...
    class C05451 implements Runnable {
        ...
        C05451(zzhg com_google_android_gms_internal_zzhg, zza com_google_android_gms_internal_zzhs_zza) {
    ...
    public void zza(zza com_google_android_gms_internal_zzhs_zza, zzcg com_google_android_gms_internal_zzcg) {
        if (com_google_android_gms_internal_zzhs_zza.errorCode != -2) {
            zzid.zzIE.post(new C05451(this, com_google_android_gms_internal_zzhs_zza));
            return;
        }
        this.zzot.zzqH = 0;
        ...
        if (com_google_android_gms_internal_zzhh2 == null) {
            try {
                ...
                try {
                    ...
                    com_google_android_gms_internal_zzhh2 = com_google_android_gms_internal_zzhh;
                } catch (Exception e2) {
                    e = e2;
