...
public class zzja extends WebViewClient {
    ...
    class C05721 implements Runnable {
        ...
        C05721(zzja com_google_android_gms_internal_zzja) {
    ...
    public final void onLoadResource(android.webkit.WebView webView, String str) {
        com.google.android.gms.ads.internal.util.client.zzb.m41v("Loading resource: " + str);
        Uri parse = Uri.parse(str);
    ...
    public final boolean shouldOverrideUrlLoading(android.webkit.WebView webView, String str) {
        com.google.android.gms.ads.internal.util.client.zzb.m41v("AdWebView shouldOverrideUrlLoading: " + str);
        Uri parse = Uri.parse(str);
        if ("gmsg".equalsIgnoreCase(parse.getScheme()) && "mobileads.google.com".equalsIgnoreCase(parse.getHost())) {
            zzh(parse);
    ...
    public final void zzeG() {
        synchronized (this.zzpd) {
            this.zzJZ = false;
            this.zzqW = true;
            zzid.runOnUiThread(new C05721(this));
        }
    }
