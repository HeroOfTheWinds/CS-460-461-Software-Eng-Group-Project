...
public class zzbm {
    ...
    class C04621 implements Comparator<String> {
        ...
        C04621(zzbm com_google_android_gms_internal_zzbm) {
    ...
    class C04632 implements Comparator<com.google.android.gms.internal.zzbp.zza> {
        final /* synthetic */ zzbm zzst;

        C04632(zzbm com_google_android_gms_internal_zzbm) {
            this.zzst = com_google_android_gms_internal_zzbm;
        }
    ...
    private String zzA(String str) {
        ...
        zza zzcz = zzcz();
        Arrays.sort(split, new C04621(this));
        int i = 0;
    ...
    String zzB(String str) {
        ...
        zza zzcz = zzcz();
        PriorityQueue priorityQueue = new PriorityQueue(this.zzsq, new C04632(this));
