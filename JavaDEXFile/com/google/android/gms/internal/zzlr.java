...
public abstract class zzlr<T> {
    ...
    static final class C05991 extends zzlr<Boolean> {
        C05991(String str, Boolean bool) {
            super(str, bool);
        }
    ...
    static final class C06002 extends zzlr<Long> {
        C06002(String str, Long l) {
            super(str, l);
        }
    ...
    static final class C06013 extends zzlr<Integer> {
        C06013(String str, Integer num) {
            super(str, num);
        }
    ...
    static final class C06024 extends zzlr<Float> {
        C06024(String str, Float f) {
            super(str, f);
        }
    ...
    static final class C06035 extends zzlr<String> {
        C06035(String str, String str2) {
            super(str, str2);
        }
