...
public abstract class zza<T extends LifecycleDelegate> {
    ...
    class C04181 implements zzf<T> {
        final /* synthetic */ zza zzapr;

        C04181(zza com_google_android_gms_dynamic_zza) {
    ...
    class C04192 implements zza {
        final /* synthetic */ zza zzapr;
        final /* synthetic */ Activity zzaps;
        final /* synthetic */ Bundle zzapt;
        final /* synthetic */ Bundle zzapu;

        C04192(zza com_google_android_gms_dynamic_zza, Activity activity, Bundle bundle, Bundle bundle2) {
            this.zzapr = com_google_android_gms_dynamic_zza;
            this.zzaps = activity;
            this.zzapt = bundle;
            this.zzapu = bundle2;
    ...
    class C04203 implements zza {
        final /* synthetic */ zza zzapr;
        final /* synthetic */ Bundle zzapu;

        C04203(zza com_google_android_gms_dynamic_zza, Bundle bundle) {
            this.zzapr = com_google_android_gms_dynamic_zza;
            this.zzapu = bundle;
        }
    ...
    class C04214 implements zza {
        ...
        C04214(zza com_google_android_gms_dynamic_zza, FrameLayout frameLayout, LayoutInflater layoutInflater, ViewGroup viewGroup, Bundle bundle) {
            this.zzapr = com_google_android_gms_dynamic_zza;
    ...
    static final class C04225 implements OnClickListener {
        final /* synthetic */ int zzapy;
        final /* synthetic */ Context zzry;

        C04225(Context context, int i) {
            this.zzry = context;
            this.zzapy = i;
        }
    ...
    class C04236 implements zza {
        final /* synthetic */ zza zzapr;

        C04236(zza com_google_android_gms_dynamic_zza) {
            this.zzapr = com_google_android_gms_dynamic_zza;
        }
    ...
    class C04247 implements zza {
        final /* synthetic */ zza zzapr;

        C04247(zza com_google_android_gms_dynamic_zza) {
            this.zzapr = com_google_android_gms_dynamic_zza;
        }
    ...
    public static void zzb(FrameLayout frameLayout) {
        ...
        if (zzh != null) {
            ...
            button.setOnClickListener(new C04225(context, isGooglePlayServicesAvailable));
        }
    }
    ...
    public void onCreate(Bundle bundle) {
        zza(bundle, new C04203(this, bundle));
    }

    public View onCreateView(LayoutInflater layoutInflater, ViewGroup viewGroup, Bundle bundle) {
        FrameLayout frameLayout = new FrameLayout(layoutInflater.getContext());
        zza(bundle, new C04214(this, frameLayout, layoutInflater, viewGroup, bundle));
        if (this.zzapn == null) {
            zza(frameLayout);
        }
        return frameLayout;
    ...
    public void onInflate(Activity activity, Bundle bundle, Bundle bundle2) {
        zza(bundle2, new C04192(this, activity, bundle, bundle2));
    }
