...
public class ActivityRecognitionResult implements SafeParcelable {
    ...
    public boolean equals(Object obj) {
        if (this != obj) {
            ...
            if (this.zzaEc != activityRecognitionResult.zzaEc || this.zzaEd != activityRecognitionResult.zzaEd || this.zzaEe != activityRecognitionResult.zzaEe) {
                return false;
            }
            if (!zzw.equal(this.zzaEb, activityRecognitionResult.zzaEb)) {
                return false;
            }
        }
        return true;
