...
public class zzj implements PlaceDetectionApi {
    ...
    class C06491 extends zzd<zzk> {
        final /* synthetic */ PlaceFilter zzaHf;
        final /* synthetic */ zzj zzaHg;

        C06491(zzj com_google_android_gms_location_places_internal_zzj, zzc com_google_android_gms_common_api_Api_zzc, GoogleApiClient googleApiClient, PlaceFilter placeFilter) {
    ...
    class C06502 extends zzf<zzk> {
        final /* synthetic */ zzj zzaHg;
        final /* synthetic */ PlaceReport zzaHh;

        C06502(zzj com_google_android_gms_location_places_internal_zzj, zzc com_google_android_gms_common_api_Api_zzc, GoogleApiClient googleApiClient, PlaceReport placeReport) {
            this.zzaHg = com_google_android_gms_location_places_internal_zzj;
    ...
    public PendingResult<PlaceLikelihoodBuffer> getCurrentPlace(GoogleApiClient googleApiClient, PlaceFilter placeFilter) {
        return googleApiClient.zza(new C06491(this, Places.zzaGA, googleApiClient, placeFilter));
    }

    public PendingResult<Status> reportDeviceAtPlace(GoogleApiClient googleApiClient, PlaceReport placeReport) {
        return googleApiClient.zzb(new C06502(this, Places.zzaGA, googleApiClient, placeReport));
    }
}
