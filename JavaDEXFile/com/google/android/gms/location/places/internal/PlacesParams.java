...
public class PlacesParams implements SafeParcelable {
    ...
    public boolean equals(Object obj) {
        if (this != obj) {
            ...
            if (!this.zzaHS.equals(placesParams.zzaHS) || !this.zzaHR.equals(placesParams.zzaHR) || !zzw.equal(this.zzaHT, placesParams.zzaHT) || !zzw.equal(this.zzaGG, placesParams.zzaGG)) {
                return false;
            }
            if (!zzw.equal(this.zzaHU, placesParams.zzaHU)) {
                return false;
            }
        }
        return true;
