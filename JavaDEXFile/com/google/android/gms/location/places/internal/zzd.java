...
public class zzd implements GeoDataApi {
    ...
    class C06451 extends zzc<zze> {
        final /* synthetic */ AddPlaceRequest zzaGV;
        final /* synthetic */ zzd zzaGW;

        C06451(zzd com_google_android_gms_location_places_internal_zzd, Api.zzc com_google_android_gms_common_api_Api_zzc, GoogleApiClient googleApiClient, AddPlaceRequest addPlaceRequest) {
    ...
    class C06462 extends zzc<zze> {
        final /* synthetic */ zzd zzaGW;
        final /* synthetic */ String[] zzaGX;

        C06462(zzd com_google_android_gms_location_places_internal_zzd, Api.zzc com_google_android_gms_common_api_Api_zzc, GoogleApiClient googleApiClient, String[] strArr) {
            this.zzaGW = com_google_android_gms_location_places_internal_zzd;
            this.zzaGX = strArr;
            super(com_google_android_gms_common_api_Api_zzc, googleApiClient);
        }
    ...
    class C06473 extends zza<zze> {
        final /* synthetic */ zzd zzaGW;
        final /* synthetic */ LatLngBounds zzaGY;
        final /* synthetic */ AutocompleteFilter zzaGZ;
        final /* synthetic */ String zzaxk;

        C06473(zzd com_google_android_gms_location_places_internal_zzd, Api.zzc com_google_android_gms_common_api_Api_zzc, GoogleApiClient googleApiClient, String str, LatLngBounds latLngBounds, AutocompleteFilter autocompleteFilter) {
            this.zzaGW = com_google_android_gms_location_places_internal_zzd;
            this.zzaxk = str;
    ...
    class C06484 extends zzb<zze> {
        final /* synthetic */ zzd zzaGW;
        final /* synthetic */ String zzaHa;

        C06484(zzd com_google_android_gms_location_places_internal_zzd, Api.zzc com_google_android_gms_common_api_Api_zzc, GoogleApiClient googleApiClient, String str) {
            this.zzaGW = com_google_android_gms_location_places_internal_zzd;
            this.zzaHa = str;
            super(com_google_android_gms_common_api_Api_zzc, googleApiClient);
        }
    ...
    public PendingResult<PlaceBuffer> addPlace(GoogleApiClient googleApiClient, AddPlaceRequest addPlaceRequest) {
        return googleApiClient.zzb(new C06451(this, Places.zzaGz, googleApiClient, addPlaceRequest));
    }
    ...
    public PendingResult<AutocompletePredictionBuffer> getAutocompletePredictions(GoogleApiClient googleApiClient, String str, LatLngBounds latLngBounds, AutocompleteFilter autocompleteFilter) {
        return googleApiClient.zza(new C06473(this, Places.zzaGz, googleApiClient, str, latLngBounds, autocompleteFilter));
    }
    ...
    public PendingResult<PlaceBuffer> getPlaceById(GoogleApiClient googleApiClient, String... strArr) {
        ...
        zzx.zzaa(z);
        return googleApiClient.zza(new C06462(this, Places.zzaGz, googleApiClient, strArr));
    }

    public PendingResult<PlacePhotoMetadataResult> getPlacePhotos(GoogleApiClient googleApiClient, String str) {
        return googleApiClient.zza(new C06484(this, Places.zzaGz, googleApiClient, str));
    }
}
