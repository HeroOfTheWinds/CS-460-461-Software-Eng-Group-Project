...
public class zzq implements PlacePhotoMetadata {
    ...
    class C06521 extends zza<zze> {
        final /* synthetic */ int zzaHN;
        final /* synthetic */ int zzaHO;
        final /* synthetic */ zzq zzaHP;

        C06521(zzq com_google_android_gms_location_places_internal_zzq, zzc com_google_android_gms_common_api_Api_zzc, GoogleApiClient googleApiClient, int i, int i2) {
    ...
    public PendingResult<PlacePhotoResult> getScaledPhoto(GoogleApiClient googleApiClient, int i, int i2) {
        return googleApiClient.zza(new C06521(this, Places.zzaGz, googleApiClient, i, i2));
    }
