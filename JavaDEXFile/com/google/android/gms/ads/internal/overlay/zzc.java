...
public class zzc extends zzi implements OnAudioFocusChangeListener, OnBufferingUpdateListener, OnCompletionListener, OnErrorListener, OnInfoListener, OnPreparedListener, OnVideoSizeChangedListener, SurfaceTextureListener {
    ...
    class C01601 implements Runnable {
        ...
        C01601(zzc com_google_android_gms_ads_internal_overlay_zzc) {
    ...
    class C01612 implements Runnable {
        ...
        C01612(zzc com_google_android_gms_ads_internal_overlay_zzc) {
            this.zzBe = com_google_android_gms_ads_internal_overlay_zzc;
        }
    ...
    class C01623 implements Runnable {
        ...
        C01623(zzc com_google_android_gms_ads_internal_overlay_zzc, String str, String str2) {
            this.zzBe = com_google_android_gms_ads_internal_overlay_zzc;
            this.zzBf = str;
            this.zzBg = str2;
        }
    ...
    class C01634 implements Runnable {
        ...
        C01634(zzc com_google_android_gms_ads_internal_overlay_zzc) {
            this.zzBe = com_google_android_gms_ads_internal_overlay_zzc;
        }
    ...
    class C01645 implements Runnable {
        ...
        C01645(zzc com_google_android_gms_ads_internal_overlay_zzc) {
            this.zzBe = com_google_android_gms_ads_internal_overlay_zzc;
        }
    ...
    class C01656 implements Runnable {
        ...
        C01656(zzc com_google_android_gms_ads_internal_overlay_zzc) {
            this.zzBe = com_google_android_gms_ads_internal_overlay_zzc;
        }
    ...
    class C01667 implements Runnable {
        final /* synthetic */ zzc zzBe;

        C01667(zzc com_google_android_gms_ads_internal_overlay_zzc) {
            this.zzBe = com_google_android_gms_ads_internal_overlay_zzc;
        }
    ...
    public void onCompletion(MediaPlayer mediaPlayer) {
        ...
        zzt(5);
        zzu(5);
        zzid.zzIE.post(new C01612(this));
    }
    ...
    public boolean onError(MediaPlayer mediaPlayer, int i, int i2) {
        ...
        zzt(-1);
        zzu(-1);
        zzid.zzIE.post(new C01623(this, str, str2));
        return true;
    }

    public boolean onInfo(MediaPlayer mediaPlayer, int i, int i2) {
        String str = (String) zzAO.get(Integer.valueOf(i2));
        zzb.m41v("AdMediaPlayerView MediaPlayer info: " + ((String) zzAO.get(Integer.valueOf(i))) + UpsightEndpoint.SIGNED_MESSAGE_SEPARATOR + str);
        return true;
    }
    ...
    public void onPrepared(MediaPlayer mediaPlayer) {
        ...
        zzt(2);
        this.zzAP.zzeR();
        zzid.zzIE.post(new C01601(this));
    ...
    public void onSurfaceTextureAvailable(SurfaceTexture surfaceTexture, int i, int i2) {
        ...
        zzes();
        zzid.zzIE.post(new C01634(this));
    }
    ...
    public boolean onSurfaceTextureDestroyed(SurfaceTexture surfaceTexture) {
        ...
        zzid.zzIE.post(new C01645(this));
        zzt(true);
        return true;
    }
    ...
    public void onVideoSizeChanged(MediaPlayer mediaPlayer, int i, int i2) {
        zzb.m41v("AdMediaPlayerView size changed: " + i + " x " + i2);
        this.zzAU = mediaPlayer.getVideoWidth();
        this.zzAV = mediaPlayer.getVideoHeight();
        if (this.zzAU != 0 && this.zzAV != 0) {
            requestLayout();
    ...
    public void pause() {
        ...
        if (zzew() && this.zzAS.isPlaying()) {
            this.zzAS.pause();
            zzt(4);
            zzid.zzIE.post(new C01667(this));
        }
        zzu(4);
    }
    ...
    public void play() {
        ...
        if (zzew()) {
            this.zzAS.start();
            zzt(3);
            zzid.zzIE.post(new C01656(this));
        }
        zzu(3);
    }

    public void seekTo(int i) {
        zzb.m41v("AdMediaPlayerView seek " + i);
        if (zzew()) {
            this.zzAS.seekTo(i);
            this.zzBc = 0;
            return;
