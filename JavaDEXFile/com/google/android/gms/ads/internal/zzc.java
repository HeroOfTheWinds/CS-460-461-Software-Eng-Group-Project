...
public abstract class zzc extends zzb implements zzg, zzfi {
    ...
    class C01801 implements Runnable {
        ...
        C01801(zzc com_google_android_gms_ads_internal_zzc, zza com_google_android_gms_internal_zzhs_zza) {
    ...
    class C01832 implements Runnable {
        ...
        class C01811 implements OnTouchListener {
            final /* synthetic */ zze zzoE;
            final /* synthetic */ C01832 zzoF;

            C01811(C01832 c01832, zze com_google_android_gms_ads_internal_zze) {
                this.zzoF = c01832;
        ...
        class C01822 implements OnClickListener {
            ...
            C01822(C01832 c01832, zze com_google_android_gms_ads_internal_zze) {
                this.zzoF = c01832;
                this.zzoE = com_google_android_gms_ads_internal_zze;
            }
        ...
        C01832(zzc com_google_android_gms_ads_internal_zzc, zza com_google_android_gms_internal_zzhs_zza, zzcg com_google_android_gms_internal_zzcg) {
            this.zzoC = com_google_android_gms_ads_internal_zzc;
            this.zzoB = com_google_android_gms_internal_zzhs_zza;
        ...
        public void run() {
            ...
            zza.setOnTouchListener(new C01811(this, com_google_android_gms_ads_internal_zze));
            zza.setOnClickListener(new C01822(this, com_google_android_gms_ads_internal_zze));
    ...
    protected void zza(zza com_google_android_gms_internal_zzhs_zza, zzcg com_google_android_gms_internal_zzcg) {
        if (com_google_android_gms_internal_zzhs_zza.errorCode != -2) {
            zzid.zzIE.post(new C01801(this, com_google_android_gms_internal_zzhs_zza));
            return;
        }
        ...
        zzid.zzIE.post(new C01832(this, com_google_android_gms_internal_zzhs_zza, com_google_android_gms_internal_zzcg));
    }
