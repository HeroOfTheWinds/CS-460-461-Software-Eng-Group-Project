...
public class zzh {
    ...
    class C01541 implements zzdk {
        final /* synthetic */ zzh zzwO;

        /* renamed from: com.google.android.gms.ads.internal.formats.zzh.1.1 */
        class C01531 implements com.google.android.gms.internal.zzja.zza {
            final /* synthetic */ Map zzwP;
            final /* synthetic */ C01541 zzwQ;

            C01531(C01541 c01541, Map map) {
                this.zzwQ = c01541;
                this.zzwP = map;
            }
        ...
        C01541(zzh com_google_android_gms_ads_internal_formats_zzh) {
        ...
        public void zza(zziz com_google_android_gms_internal_zziz, Map<String, String> map) {
            this.zzwO.zzoM.zzhe().zza(new C01531(this, map));
    ...
    class C01552 implements zzdk {
        final /* synthetic */ zzh zzwO;

        C01552(zzh com_google_android_gms_ads_internal_formats_zzh) {
            this.zzwO = com_google_android_gms_ads_internal_formats_zzh;
        }
    ...
    class C01563 implements zzdk {
        final /* synthetic */ zzh zzwO;

        C01563(zzh com_google_android_gms_ads_internal_formats_zzh) {
            this.zzwO = com_google_android_gms_ads_internal_formats_zzh;
        }
    ...
    class C01574 implements zzdk {
        final /* synthetic */ zzh zzwO;

        C01574(zzh com_google_android_gms_ads_internal_formats_zzh) {
            this.zzwO = com_google_android_gms_ads_internal_formats_zzh;
        }
    ...
    class C01585 implements zzdk {
        final /* synthetic */ zzh zzwO;

        C01585(zzh com_google_android_gms_ads_internal_formats_zzh) {
            this.zzwO = com_google_android_gms_ads_internal_formats_zzh;
        }
    ...
    public zziz zzdC() {
        ...
        this.zzwJ.zza("/loadHtml", new C01541(this));
        this.zzwJ.zza("/showOverlay", new C01552(this));
        this.zzwJ.zza("/hideOverlay", new C01563(this));
        this.zzoM.zzhe().zza("/hideOverlay", new C01574(this));
        this.zzoM.zzhe().zza("/sendMessageToSdk", new C01585(this));
        return this.zzoM;
    }
