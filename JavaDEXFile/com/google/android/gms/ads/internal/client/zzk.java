...
public final class zzk {
    ...
    public zzk(Context context, AttributeSet attributeSet) {
        Object obj = null;
        TypedArray obtainAttributes = context.getResources().obtainAttributes(attributeSet, C0148R.styleable.AdsAttrs);
        Object string = obtainAttributes.getString(C0148R.styleable.AdsAttrs_adSize);
        Object string2 = obtainAttributes.getString(C0148R.styleable.AdsAttrs_adSizes);
        ...
        this.zzpa = obtainAttributes.getString(C0148R.styleable.AdsAttrs_adUnitId);
