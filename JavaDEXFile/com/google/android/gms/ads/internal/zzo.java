...
public class zzo {
    ...
    class C01911 implements Runnable {
        ...
        C01911(zzo com_google_android_gms_ads_internal_zzo, WeakReference weakReference) {
    ...
    zzo(zza com_google_android_gms_ads_internal_zza, zza com_google_android_gms_ads_internal_zzo_zza) {
        ...
        this.zzx = new C01911(this, new WeakReference(com_google_android_gms_ads_internal_zza));
    }
