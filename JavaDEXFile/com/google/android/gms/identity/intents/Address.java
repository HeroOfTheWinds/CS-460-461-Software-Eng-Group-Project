...
public final class Address {
    ...
    static final class C04341 extends com.google.android.gms.common.api.Api.zza<zzoy, AddressOptions> {
        C04341() {
        }
    ...
    static final class C04352 extends zza {
        final /* synthetic */ UserAddressRequest zzaDf;
        final /* synthetic */ int zzaDg;

        C04352(GoogleApiClient googleApiClient, UserAddressRequest userAddressRequest, int i) {
    ...
    public static void requestUserAddress(GoogleApiClient googleApiClient, UserAddressRequest userAddressRequest, int i) {
        googleApiClient.zza(new C04352(googleApiClient, userAddressRequest, i));
    }
}
