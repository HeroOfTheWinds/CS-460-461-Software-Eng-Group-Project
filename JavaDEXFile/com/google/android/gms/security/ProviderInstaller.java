...
public class ProviderInstaller {
    ...
    static final class C06541 extends AsyncTask<Void, Void, Integer> {
        final /* synthetic */ ProviderInstallListener zzaUW;
        final /* synthetic */ Context zzry;

        C06541(Context context, ProviderInstallListener providerInstallListener) {
            this.zzry = context;
    ...
    public static void installIfNeededAsync(Context context, ProviderInstallListener providerInstallListener) {
        ...
        new C06541(context, providerInstallListener).execute(new Void[0]);
    }
