...
public abstract class GcmListenerService extends Service {
    ...
    class C04251 implements Runnable {
        ...
        C04251(GcmListenerService gcmListenerService, Intent intent) {
    ...
    class C04262 extends AsyncTask<Void, Void, Void> {
        final /* synthetic */ Intent val$intent;
        final /* synthetic */ GcmListenerService zzaCg;

        C04262(GcmListenerService gcmListenerService, Intent intent) {
            this.zzaCg = gcmListenerService;
            this.val$intent = intent;
        }
    ...
    L_0x0025:
        ...
        r0 = r2.append(r0);	 Catch:{ all -> 0x0084 }
    ...
    public final int onStartCommand(Intent intent, int i, int i2) {
        ...
        if (VERSION.SDK_INT >= 11) {
            AsyncTask.THREAD_POOL_EXECUTOR.execute(new C04251(this, intent));
        } else {
            new C04262(this, intent).execute(new Void[0]);
        }
        return 3;
    }
