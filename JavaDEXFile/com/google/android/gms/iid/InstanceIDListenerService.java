...
public class InstanceIDListenerService extends Service {
    ...
    class C04371 extends Handler {
        final /* synthetic */ InstanceIDListenerService zzaDJ;

        C04371(InstanceIDListenerService instanceIDListenerService, Looper looper) {
    ...
    class C04382 extends BroadcastReceiver {
        final /* synthetic */ InstanceIDListenerService zzaDJ;

        C04382(InstanceIDListenerService instanceIDListenerService) {
            this.zzaDJ = instanceIDListenerService;
        }
    ...
    public InstanceIDListenerService() {
        this.zzaDD = new MessengerCompat(new C04371(this, Looper.getMainLooper()));
        this.zzaDE = new C04382(this);
    }
