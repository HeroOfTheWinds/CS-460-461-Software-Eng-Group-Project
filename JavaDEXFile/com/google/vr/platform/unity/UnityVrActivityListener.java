...
public class UnityVrActivityListener implements AndroidInputListener {
    ...
    class C07313 implements Runnable {
    ...
    public UnityVrActivityListener() {
        ...
        this.touchX = 0;
        this.touchY = 0;
        this.vrBackButtonListener = new C07291();
    ...
    public void injectKeyPress(int i) {
        injectKeyDown(i);
        this.unityActivity.getUnityPlayer().postDelayed(new C07313(i), TAP_TIME_MS);
    }
    ...
    public void injectSingleTap() {
        if (!this.tapInProgress) {
            ...
            int i = this.touchX;
            int i2 = this.touchY;
            this.unityActivity.getUnityPlayer().postDelayed(new C07302(i, i2, injectTouchDown(i, i2)), TAP_TIME_MS);
        }
    }
