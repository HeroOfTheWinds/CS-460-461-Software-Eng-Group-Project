...
public final class Excluder implements TypeAdapterFactory, Cloneable {
    ...
    class C06811 extends TypeAdapter<T> {
        ...
        C06811(boolean z, boolean z2, Gson gson, TypeToken typeToken) {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> typeToken) {
        ...
        return (excludeClass || excludeClass2) ? new C06811(excludeClass2, excludeClass, gson, typeToken) : null;
    }
