...
public final class LinkedTreeMap<K, V> extends AbstractMap<K, V> implements Serializable {
    ...
    static final class C06851 implements Comparator<Comparable> {
        C06851() {
        }
    ...
    class EntrySet extends AbstractSet<Entry<K, V>> {
        ...
        class C06861 extends LinkedTreeMapIterator<Entry<K, V>> {
            C06861() {
                super();
            }
    ...
    final class KeySet extends AbstractSet<K> {
        ...
        class C06871 extends LinkedTreeMapIterator<K> {
            C06871() {
                super();
            }
