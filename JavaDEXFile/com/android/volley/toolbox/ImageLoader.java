...
public class ImageLoader {
    ...
    static final class C01411 implements ImageListener {
        final /* synthetic */ int val$defaultImageResId;
        final /* synthetic */ int val$errorImageResId;
        final /* synthetic */ ImageView val$view;

        C01411(int i, ImageView imageView, int i2) {
    ...
    class C01422 implements Listener<Bitmap> {
    ...
    class C01433 implements ErrorListener {
        final /* synthetic */ String val$cacheKey;
    ...
    class C01444 implements Runnable {
        C01444() {
        }
    ...
    public static ImageListener getImageListener(ImageView imageView, int i, int i2) {
        return new C01411(i2, imageView, i);
    }
    ...
    protected Request<Bitmap> makeImageRequest(String str, int i, int i2, ScaleType scaleType, String str2) {
        return new ImageRequest(str, new C01422(str2), i, i2, scaleType, Config.RGB_565, new C01433(str2));
    }
