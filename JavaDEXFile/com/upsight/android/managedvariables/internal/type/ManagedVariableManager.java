...
public class ManagedVariableManager {
    ...
    static final class C09231 extends HashMap<Class<? extends ManagedVariable>, Class<? extends ManagedVariableModel>> {
        C09231() {
    ...
    class C09242 implements Action1<T> {
        final /* synthetic */ Listener val$listener;

        C09242(Listener listener) {
    ...
    class C09253 implements Action1<ManagedVariableModel> {
        final /* synthetic */ Class val$clazz;
        final /* synthetic */ Listener val$listener;
        final /* synthetic */ String val$tag;

        C09253(String str, Listener listener, Class cls) {
            this.val$tag = str;
            this.val$listener = listener;
            this.val$clazz = cls;
        }
    ...
    class C09275 implements Func1<ManagedVariableModel, Boolean> {
        final /* synthetic */ Class val$clazz;
        final /* synthetic */ String val$tag;

        C09275(Class cls, String str) {
            this.val$clazz = cls;
            this.val$tag = str;
        }
    ...
    private <T extends ManagedVariable> Observable<? extends ManagedVariableModel> fetchDataStoreObservable(Class<T> cls, String str) {
        return this.mDataStore.fetchObservable((Class) sModelMap.get(cls)).filter(new C09275(cls, str)).defaultIfEmpty(null);
    }
    ...
    public <T extends ManagedVariable> UpsightSubscription fetch(Class<T> cls, String str, Listener<T> listener) {
        ...
        synchronized (this.mCache) {
            ManagedVariable managedVariable = (ManagedVariable) this.mCache.get(str);
            from = managedVariable != null ? Subscriptions.from(Observable.just(managedVariable).observeOn(this.mCallbackScheduler).subscribe(new C09242(listener))) : Subscriptions.from(fetchDataStoreObservable(cls, str).subscribe(new C09253(str, listener, cls), new C09264(listener)));
        }
        return from;
    }
