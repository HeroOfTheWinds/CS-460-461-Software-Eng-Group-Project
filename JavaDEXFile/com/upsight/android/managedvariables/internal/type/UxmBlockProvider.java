...
public class UxmBlockProvider extends AbstractUxmBlockProvider implements OnSharedPreferenceChangeListener {
    ...
    class C09281 implements Observer {
        C09281() {
        }
    ...
    UxmBlockProvider(UpsightContext upsightContext, @Named("stringRawUxmSchema") String str, UxmSchema uxmSchema) {
        this.mBundleHashObserver = new C09281();
        ...
        try {
            ...
            upsightContext.getLogger().m208e(Upsight.LOG_TAG, e, "Failed to generate UXM hashes because SHA-1 is unavailable on this device", new Object[0]);
        }
