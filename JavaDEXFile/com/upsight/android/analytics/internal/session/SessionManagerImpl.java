        ...
        try {
            ...
            if (bundle != null && bundle.containsKey(KEY_SESSION)) {
                try {
                    ...
                    this.mLogger.m207e(Upsight.LOG_TAG, String.format("Unexpected error: Class: %s was not found.", new Object[]{r1}), e);
                } catch (IllegalAccessException e2) {
                    this.mLogger.m207e(Upsight.LOG_TAG, String.format("Unexpected error: Class: %s does not have public access.", new Object[]{r1}), e2);
                } catch (InstantiationException e3) {
                    this.mLogger.m207e(Upsight.LOG_TAG, String.format("Unexpected error: Class: %s could not be instantiated", new Object[]{r1}), e3);
                }
            }
