...
public class DeviceBlockProvider extends UpsightDataProvider {
    ...
    DeviceBlockProvider(UpsightContext upsightContext) {
    ...
    public void onNetworkChangeEvent(NetworkChangeEvent networkChangeEvent) {
        put(CARRIER_KEY, networkChangeEvent.networkOperatorName);
        put(CONNECTION_KEY, networkChangeEvent.activeNetworkType);
    }
}
