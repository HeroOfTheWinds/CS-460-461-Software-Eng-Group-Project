...
class UpsightEndpoint {
            ...
            if (inputStream != null) {
                ...
                if (!TextUtils.isEmpty(iOUtils)) {
                    try {
                        ...
                        this.mLogger.m208e(Upsight.LOG_TAG, e, "Message signature is not valid Base64. X-US-DIGEST: " + headerField, new Object[0]);
                        return EMPTY_STRING;
                    }
                }
            }
    ...
    public Response send(UpsightRequest upsightRequest) throws IOException {
        ...
        try {
            String toJson = this.mGson.toJson((Object) upsightRequest);
            this.mLogger.m205d(Upsight.LOG_TAG, LOG_TEXT_POSTING + uuid + LOG_TEXT_TO + this.mEndpointAddress + LOG_TEXT_REQUEST_BODY + this.mRequestLoggingGson.toJson((Object) upsightRequest), new Object[0]);
            byte[] requestBodyBytes = getRequestBodyBytes(toJson, false);
            ...
            try {
                ...
                if (responseCode == 200) {
                    ...
                    append.append(LOG_TEXT_RESPONSE_BODY).append(TextUtils.isEmpty(verifiedResponse) ? LOG_TEXT_RESPONSE_BODY_NONE : this.mRequestLoggingGson.toJson(this.mJsonParser.parse(verifiedResponse)));
                }
                this.mLogger.m205d(Upsight.LOG_TAG, append.toString(), new Object[0]);
