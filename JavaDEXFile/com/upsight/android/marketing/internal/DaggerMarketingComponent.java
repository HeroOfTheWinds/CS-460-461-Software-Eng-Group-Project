...
public final class DaggerMarketingComponent implements MarketingComponent {
    ...
    public void inject(BillboardDialogFragment billboardDialogFragment) {
        this.billboardDialogFragmentMembersInjector.injectMembers(billboardDialogFragment);
    }

    public void inject(BillboardManagementActivity billboardManagementActivity) {
        this.billboardManagementActivityMembersInjector.injectMembers(billboardManagementActivity);
    }
}
