...
public final class Logger implements UpsightLogger {
    ...
    class C09061 implements UpsightDataStoreListener<LogMessage> {
        C09061() {
        }
    ...
    private void log(Level level, String str, Throwable th, String str2, Object... objArr) {
        ...
        this.mDataStore.store(new LogMessage(str, level, formatString(str2, objArr), stringWriter.getBuffer().toString()), new C09061());
    }

    public void m225d(String str, String str2, Object... objArr) {
        log(Level.DEBUG, str, null, str2, objArr);
    }

    public void m226d(String str, Throwable th, String str2, Object... objArr) {
        log(Level.DEBUG, str, th, str2, objArr);
    }

    public void m227e(String str, String str2, Object... objArr) {
        log(Level.ERROR, str, null, str2, objArr);
    }

    public void m228e(String str, Throwable th, String str2, Object... objArr) {
    ...
    public void m230i(String str, Throwable th, String str2, Object... objArr) {
    ...
    public void m232v(String str, Throwable th, String str2, Object... objArr) {
    ...
    public void m234w(String str, Throwable th, String str2, Object... objArr) {
