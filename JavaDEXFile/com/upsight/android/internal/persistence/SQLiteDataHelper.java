...
class SQLiteDataHelper implements DataHelper {
    ...
    public int delete(String str, String[] strArr) {
        int delete;
        synchronized (this) {
            delete = this.mOpenHelper.getWritableDatabase().delete(TABLE_MODELS, str, strArr);
        }
        return delete;
    }
    ...
    public long insert(ContentValues contentValues) {
        long insert;
        synchronized (this) {
            insert = this.mOpenHelper.getWritableDatabase().insert(TABLE_MODELS, null, contentValues);
        }
        return insert;
    }
    ...
    public Cursor query(String[] strArr, String str, String[] strArr2, String str2) {
        Cursor query;
        synchronized (this) {
            query = this.mOpenHelper.getReadableDatabase().query(TABLE_MODELS, strArr, str, strArr2, null, null, str2);
        }
        return query;
    }
    ...
    public int update(ContentValues contentValues, String str, String[] strArr) {
        int update;
        synchronized (this) {
            update = this.mOpenHelper.getWritableDatabase().update(TABLE_MODELS, contentValues, str, strArr);
        }
        return update;
    }
}
