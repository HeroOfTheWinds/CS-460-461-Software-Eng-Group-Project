...
class DataStore implements UpsightDataStore {
    ...
    class C09071 implements Action1<List<T>> {
        final /* synthetic */ UpsightDataStoreListener val$listener;

        C09071(UpsightDataStoreListener upsightDataStoreListener) {
            this.val$listener = upsightDataStoreListener;
        }
    ...
    class C09082 implements Action1<Throwable> {
        final /* synthetic */ UpsightDataStoreListener val$listener;

        C09082(UpsightDataStoreListener upsightDataStoreListener) {
            this.val$listener = upsightDataStoreListener;
        }
    ...
    class C09093 implements Action1<List<T>> {
        final /* synthetic */ UpsightDataStoreListener val$listener;

        C09093(UpsightDataStoreListener upsightDataStoreListener) {
            this.val$listener = upsightDataStoreListener;
        }
    ...
    class C09104 implements Action1<Throwable> {
        final /* synthetic */ UpsightDataStoreListener val$listener;

        C09104(UpsightDataStoreListener upsightDataStoreListener) {
            this.val$listener = upsightDataStoreListener;
        }
    ...
    class C09115 implements Action1<List<T>> {
        final /* synthetic */ UpsightDataStoreListener val$listener;

        C09115(UpsightDataStoreListener upsightDataStoreListener) {
            this.val$listener = upsightDataStoreListener;
        }
    ...
    class C09126 implements Action1<Throwable> {
        final /* synthetic */ UpsightDataStoreListener val$listener;

        C09126(UpsightDataStoreListener upsightDataStoreListener) {
            this.val$listener = upsightDataStoreListener;
        }
    ...
    class C09137 implements Action1<T> {
        final /* synthetic */ UpsightDataStoreListener val$listener;

        C09137(UpsightDataStoreListener upsightDataStoreListener) {
            this.val$listener = upsightDataStoreListener;
        }
    ...
    class C09148 implements Action1<Throwable> {
        final /* synthetic */ UpsightDataStoreListener val$listener;

        C09148(UpsightDataStoreListener upsightDataStoreListener) {
            this.val$listener = upsightDataStoreListener;
        }
    ...
    class C09159 implements Action1<T> {
        final /* synthetic */ UpsightDataStoreListener val$listener;

        C09159(UpsightDataStoreListener upsightDataStoreListener) {
            this.val$listener = upsightDataStoreListener;
        }
    ...
    public <T> UpsightSubscription fetch(Class<T> cls, UpsightDataStoreListener<Set<T>> upsightDataStoreListener) {
        if (cls == null) {
            ...
            return Subscriptions.from(fetchObservable(cls).toList().subscribeOn(this.mSubscribeOnScheduler).observeOn(this.mObserveOnScheduler).subscribe(new C09071(upsightDataStoreListener), new C09082(upsightDataStoreListener)));
        } else {
    ...
    public <T> UpsightSubscription fetch(Class<T> cls, Set<String> set, UpsightDataStoreListener<Set<T>> upsightDataStoreListener) {
        return Subscriptions.from(fetchObservable(cls, (String[]) set.toArray(new String[set.size()])).toList().subscribeOn(this.mSubscribeOnScheduler).observeOn(this.mObserveOnScheduler).subscribe(new C09093(upsightDataStoreListener), new C09104(upsightDataStoreListener)));
    }
    ...
    public <T> UpsightSubscription remove(Class<T> cls, Set<String> set, UpsightDataStoreListener<Set<T>> upsightDataStoreListener) {
        return Subscriptions.from(removeObservable(cls, (String[]) set.toArray(new String[set.size()])).toList().subscribeOn(this.mSubscribeOnScheduler).observeOn(this.mObserveOnScheduler).subscribe(new C09115(upsightDataStoreListener), new C09126(upsightDataStoreListener)));
    }
    ...
    public <T> UpsightSubscription remove(T t, UpsightDataStoreListener<T> upsightDataStoreListener) {
        if (upsightDataStoreListener != null) {
            return Subscriptions.from(removeObservable(t).subscribeOn(this.mSubscribeOnScheduler).observeOn(this.mObserveOnScheduler).subscribe(new C09159(upsightDataStoreListener), new AnonymousClass10(upsightDataStoreListener)));
        }
    ...
    public <T> UpsightSubscription store(T t, UpsightDataStoreListener<T> upsightDataStoreListener) {
        return Subscriptions.from(storeObservable(t).subscribeOn(this.mSubscribeOnScheduler).observeOn(this.mObserveOnScheduler).subscribe(new C09137(upsightDataStoreListener), new C09148(upsightDataStoreListener)));
    }
