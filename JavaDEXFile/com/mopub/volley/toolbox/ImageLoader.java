...
public class ImageLoader {
    ...
    static final class C07381 implements ImageListener {
        final /* synthetic */ int val$defaultImageResId;
        final /* synthetic */ int val$errorImageResId;
        final /* synthetic */ ImageView val$view;

        C07381(int i, ImageView imageView, int i2) {
    ...
    class C07392 implements Listener<Bitmap> {
    ...
    class C07403 implements ErrorListener {
        final /* synthetic */ String val$cacheKey;
    ...
    public static ImageListener getImageListener(ImageView imageView, int i, int i2) {
        return new C07381(i2, imageView, i);
    }
    ...
    protected Request<Bitmap> makeImageRequest(String str, int i, int i2, String str2) {
        return new ImageRequest(str, new C07392(str2), i, i2, Config.RGB_565, new C07403(str2));
    }
