...
public class VolleyLog {
        ...
        public void finish(String str) {
            synchronized (this) {
                ...
                if (getTotalDuration() > 0) {
                    ...
                    VolleyLog.m42d("(%-4d ms) %s", Long.valueOf(r2), str);
                    long j2 = j;
                    for (Marker marker : this.mMarkers) {
                        VolleyLog.m42d("(+%-4d) [%2d] %s", Long.valueOf(marker.time - j2), Long.valueOf(marker.thread), marker.name);
                        j2 = marker.time;
                    }
                }
            }
    ...
    private static String buildMessage(String str, Object... objArr) {
        ...
        for (int i = 2; i < stackTrace.length; i++) {
            if (!stackTrace[i].getClass().equals(VolleyLog.class)) {
                ...
                str2 = str2.substring(str2.lastIndexOf(36) + 1) + "." + stackTrace[i].getMethodName();
                break;
            }
        }
    ...
    public static void m42d(String str, Object... objArr) {
        Log.d(TAG, buildMessage(str, objArr));
    }

    public static void m43e(String str, Object... objArr) {
        Log.e(TAG, buildMessage(str, objArr));
    }

    public static void m44e(Throwable th, String str, Object... objArr) {
        Log.e(TAG, buildMessage(str, objArr), th);
    }

    public static void setTag(String str) {
        m42d("Changing log tag to %s", str);
        TAG = str;
        DEBUG = Log.isLoggable(TAG, 2);
    }

    public static void m45v(String str, Object... objArr) {
        if (DEBUG) {
