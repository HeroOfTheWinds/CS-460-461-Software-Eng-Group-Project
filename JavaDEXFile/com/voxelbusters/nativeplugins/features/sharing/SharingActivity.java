...
public class SharingActivity extends Activity {
    ...
    class C10432 implements OnKeyListener {
        C10432() {
        }
    ...
    private void shareItem(String str, String str2, String str3, String str4, String[] strArr) {
        ...
        if (i != 0) {
            Builder positiveButton = new Builder(this).setTitle("Share").setMessage("No services found!").setPositiveButton(17039370, new C10421());
            positiveButton.setOnKeyListener(new C10432());
