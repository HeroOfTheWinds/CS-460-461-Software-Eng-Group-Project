...
public class UiActivity extends Activity {
    ...
    class C10452 implements OnClickListener {
        ...
        C10452(String[] strArr, int i, String str) {
    ...
    class C10463 implements OnClickListener {
        private final /* synthetic */ int val$index;
        private final /* synthetic */ EditText val$promptField;
        private final /* synthetic */ String[] val$tempButtonList;

        C10463(EditText editText, String[] strArr, int i) {
    ...
    class C10474 implements OnClickListener {
        ...
        C10474(String[] strArr, int i, EditText editText, EditText editText2) {
    ...
    private void showAlertDialog(Bundle bundle) {
        ...
        for (int i2 = 0; i2 < i; i2++) {
            this.alertDialog.setButton(-1 - i2, stringArray[i2], new C10452(stringArray, i2, string));
        }
    ...
    private void showLoginPrompt(Bundle bundle) {
        ...
        for (int i = 0; i < length; i++) {
            this.alertDialog.setButton(-1 - i, stringArray[i], new C10474(stringArray, i, editText, editText2));
        }
        this.alertDialog.show();
    }
    ...
    private void showSinglePrompt(Bundle bundle) {
        ...
        for (int i2 = 0; i2 < i; i2++) {
            this.alertDialog.setButton(-1 - i2, stringArray[i2], new C10463(editText, stringArray, i2));
        }
        this.alertDialog.show();
    }
    ...
    protected void onResume() {
        ...
        if (this.paused) {
            finish();
            new Handler().postDelayed(new C10441(), 10);
        }
    }
}
