...
public class NianticLocationManager extends ContextService {
    ...
    class C07731 implements GpsProviderListener {
    ...
    class C07742 implements ProviderListener {
        final /* synthetic */ String val$name;
    ...
    private void addProvider(String str, Provider provider) {
        ...
        if (provider instanceof GpsProvider) {
            provider.setListener(new C07731(str));
        } else {
            provider.setListener(new C07742(str));
        }
    }
    ...
    public void configureLocationParameters(double d, int i, int i2) {
        ContextService.runOnServiceHandler(new C07753(i, d, i2));
    }
