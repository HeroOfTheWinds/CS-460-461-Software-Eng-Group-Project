...
public class NianticActivityManager extends ContextService {
    ...
    class C07801 implements Listener {
        C07801() {
        }
    ...
    class C07812 implements Runnable {
        ...
        C07812(ActivityRecognitionResult activityRecognitionResult) {
    ...
    public NianticActivityManager(Context context, long j) {
        ...
        this.googleApiListener = new C07801();
    ...
    public static NianticActivityManager getInstance() {
        synchronized (instanceLock) {
            if (instance != null) {
                NianticActivityManager nianticActivityManager = (NianticActivityManager) instance.get();
    ...
    public void receiveUpdateActivity(ActivityRecognitionResult activityRecognitionResult) {
        ContextService.runOnServiceHandler(new C07812(activityRecognitionResult));
    }
}
