...
public class ActivityRecognitionService extends IntentService {
    ...
    class C07791 implements ConnectionCallbacks {
        C07791() {
        }
    ...
    private void unregisterIntent() {
        this.googleApiClient = new Builder(this).addApi(ActivityRecognition.API).addConnectionCallbacks(new C07791()).build();
