...
public class ConsoleView extends LinearLayout implements Destroyable, LunarConsoleListener, OnStateChangeListener {
    ...
    class C15301 implements OnTouchListener {
        C15301() {
        }
    ...
    class C15332 implements OnItemClickListener {
        ...
        class C15311 implements Runnable {
            ...
            C15311(View view, ConsoleEntry consoleEntry, Context context) {
                this.val$view = view;
        ...
        class C15322 implements OnClickListener {
            ...
            C15322(String str, ConsoleEntry consoleEntry, String str2) {
        ...
        public void onItemClick(AdapterView<?> adapterView, View view, int i, long j) {
            ...
            ThreadUtils.runOnUIThread(new C15311(view, entry, context), 200);
            Builder builder = new Builder(context);
            View inflate = LayoutInflater.from(context).inflate(C1518R.layout.lunar_layout_log_details_dialog, null);
            ImageView imageView = (ImageView) inflate.findViewById(C1518R.id.lunar_console_log_details_icon);
            TextView textView = (TextView) inflate.findViewById(C1518R.id.lunar_console_log_details_message);
            TextView textView2 = (TextView) inflate.findViewById(C1518R.id.lunar_console_log_details_stacktrace);
            Object obj = entry.message;
            Object optimize = entry.hasStackTrace() ? StackTrace.optimize(entry.stackTrace) : ConsoleView.this.getResources().getString(C1518R.string.lunar_console_log_details_dialog_no_stacktrace_warning);
            textView.setText(obj);
            textView2.setText(optimize);
            imageView.setImageDrawable(entry.getIconDrawable(context));
            builder.setView(inflate);
            builder.setPositiveButton(C1518R.string.lunar_console_log_details_dialog_button_copy_to_clipboard, new C15322(obj, entry, optimize));
            builder.create().show();
        }
    }

    /* renamed from: spacemadness.com.lunarconsole.console.ConsoleView.3 */
    class C15343 implements OnTouchListener {
        C15343() {
        }
    ...
    class C15354 implements TextWatcher {
        C15354() {
        }
    ...
    class C15365 implements View.OnClickListener {
        C15365() {
        }
    ...
    class C15376 implements OnEditorActionListener {
        C15376() {
        }
    ...
    class C15387 implements View.OnClickListener {
        C15387() {
        }
    ...
    class C15398 implements ToggleImageButton.OnStateChangeListener {
        C15398() {
        }
    ...
    class C15409 implements View.OnClickListener {
        C15409() {
        }
    ...
    public ConsoleView(Context context, Console console) {
        ...
        setOnTouchListener(new C15301());
        this.rootView = LayoutInflater.from(context).inflate(C1518R.layout.lunar_layout_console, this, false);
        addView(this.rootView, new LayoutParams(-1, -1));
        this.recyclerViewAdapter = new ConsoleAdapter(console);
        LinearLayout linearLayout = (LinearLayout) findExistingViewById(C1518R.id.lunar_console_recycler_view_container);
        ...
        this.listView.setOnItemClickListener(new C15332(console));
        this.listView.setOnTouchListener(new C15343());
        linearLayout.addView(this.listView, new LayoutParams(-1, -1));
        setupFilterTextEdit();
        this.logButton = (LogTypeButton) findExistingViewById(C1518R.id.lunar_console_log_button);
        this.warningButton = (LogTypeButton) findExistingViewById(C1518R.id.lunar_console_warning_button);
        this.errorButton = (LogTypeButton) findExistingViewById(C1518R.id.lunar_console_error_button);
        setupLogTypeButtons();
        setupOperationsButtons();
        setupFakeStatusBar();
        this.overflowText = (TextView) findExistingViewById(C1518R.id.lunar_console_text_overflow);
        reloadData();
    }
    ...
    private void setupFakeStatusBar() {
        CharSequence format = String.format(getResources().getString(C1518R.string.lunar_console_title_fake_status_bar), new Object[]{ConsolePlugin.getVersion()});
        TextView textView = (TextView) findExistingViewById(C1518R.id.lunar_console_fake_status_bar);
    ...
    private EditText setupFilterTextEdit() {
        EditText editText = (EditText) findExistingViewById(C1518R.id.lunar_console_text_edit_filter);
        ...
        editText.addTextChangedListener(new C15354());
        editText.setOnClickListener(new C15365());
        editText.setOnEditorActionListener(new C15376());
        return editText;
    }
    ...
    private void setupOperationsButtons() {
        setOnClickListener(C1518R.id.lunar_console_button_clear, new C15387());
        this.scrollLockButton = (ToggleImageButton) this.rootView.findViewById(C1518R.id.lunar_console_button_lock);
        Resources resources = getContext().getResources();
        this.scrollLockButton.setOnDrawable(resources.getDrawable(C1518R.drawable.lunar_console_icon_button_lock));
        this.scrollLockButton.setOffDrawable(resources.getDrawable(C1518R.drawable.lunar_console_icon_button_unlock));
        this.scrollLockButton.setOn(this.scrollLocked);
        this.scrollLockButton.setOnStateChangeListener(new C15398());
        setOnClickListener(C1518R.id.lunar_console_button_copy, new C15409());
        setOnClickListener(C1518R.id.lunar_console_button_email, new View.OnClickListener() {
            public void onClick(View view) {
                ConsoleView.this.sendConsoleOutputByEmail();
            }
        });
        setOnClickListener(C1518R.id.lunar_console_button_close, new View.OnClickListener() {
            public void onClick(View view) {
    ...
    private void updateOverflowText() {
        if (this.console.trimmedCount() > 0) {
            ...
            this.overflowText.setText(getResources().getString(C1518R.string.lunar_console_overflow_warning_text, new Object[]{Integer.valueOf(r0)}));
            return;
        }
