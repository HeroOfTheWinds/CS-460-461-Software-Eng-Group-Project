...
public class ConsoleEntryList {
    ...
    private boolean isFiltered(ConsoleEntry consoleEntry) {
        return (this.logDisabledTypesMask & ConsoleLogType.getMask(consoleEntry.type)) == 0 && (StringUtils.length(this.filterText) == 0 || StringUtils.containsIgnoreCase(consoleEntry.message, this.filterText));
    }
