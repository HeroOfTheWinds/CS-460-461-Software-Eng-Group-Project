...
public class FilenameUtils {
    ...
    public static String concat(String str, String str2) {
        ...
        if (prefixLength >= 0) {
            ...
            if (str != null) {
                ...
                return prefixLength == 0 ? normalize(str2) : isSeparator(str.charAt(prefixLength + -1)) ? normalize(str + str2) : normalize(str + UNIX_SEPARATOR + str2);
            }
        }
        return null;
    }
    ...
    public static String getPrefix(String str) {
        if (str != null) {
            int prefixLength = getPrefixLength(str);
            if (prefixLength >= 0) {
                return prefixLength > str.length() ? str + UNIX_SEPARATOR : str.substring(0, prefixLength);
            }
        }
        return null;
    }
    ...
    public static int getPrefixLength(String str) {
        ...
        if (length == 1) {
            ...
            r1 = indexOf == -1 ? r2 : indexOf;
            return Math.min(r1, r2 == -1 ? r1 : r2) + 1;
        } else {
    ...
    public static boolean wildcardMatch(String str, String str2, IOCase iOCase) {
        if (!(str == null && str2 == null)) {
            ...
            do {
                ...
                if (i == splitOnTokens.length && r3 == str.length()) {
                }
            } while (stack.size() > 0);
            return false;
        }
