...
public class Tailer implements Runnable {
    ...
    public void run() {
        ...
        r6 = r4;
    L_0x0005:
        r1 = r12.run;	 Catch:{ Exception -> 0x0026, all -> 0x00c4 }
        if (r1 == 0) goto L_0x00d1;
    L_0x0009:
        if (r0 != 0) goto L_0x00d1;
    L_0x000b:
        r1 = new java.io.RandomAccessFile;	 Catch:{ FileNotFoundException -> 0x001f }
        r8 = r12.file;	 Catch:{ FileNotFoundException -> 0x001f }
        r9 = "r";
    ...
    L_0x0017:
        r8 = r12.delayMillis;	 Catch:{ InterruptedException -> 0x001d }
    ...
    L_0x001f:
        r1 = move-exception;
        r1 = r12.listener;	 Catch:{ Exception -> 0x0026, all -> 0x00c4 }
        r1.fileNotFound();	 Catch:{ Exception -> 0x0026, all -> 0x00c4 }
        goto L_0x0015;
    L_0x0026:
        r1 = move-exception;
    L_0x0027:
        r2 = r12.listener;	 Catch:{ all -> 0x00ba }
        r2.handle(r1);	 Catch:{ all -> 0x00ba }
        org.apache.commons.io.IOUtils.closeQuietly(r0);
    L_0x002f:
        return;
    L_0x0030:
        r1 = r12.end;	 Catch:{ Exception -> 0x0042 }
        if (r1 == 0) goto L_0x0044;
    L_0x0034:
        r1 = r12.file;	 Catch:{ Exception -> 0x0042 }
        r2 = r1.length();	 Catch:{ Exception -> 0x0042 }
    L_0x003a:
        r6 = java.lang.System.currentTimeMillis();	 Catch:{ Exception -> 0x0042 }
        r0.seek(r2);	 Catch:{ Exception -> 0x0042 }
        goto L_0x0005;
    L_0x0042:
        r1 = move-exception;
        goto L_0x0027;
    L_0x0044:
        ...
        goto L_0x003a;
    L_0x0046:
        r0 = r12.run;	 Catch:{ Exception -> 0x00cb, all -> 0x00c6 }
        if (r0 == 0) goto L_0x00b5;
    L_0x004a:
        r0 = r12.file;	 Catch:{ Exception -> 0x00cb, all -> 0x00c6 }
        r0 = org.apache.commons.io.FileUtils.isFileNewer(r0, r6);	 Catch:{ Exception -> 0x00cb, all -> 0x00c6 }
        r8 = r12.file;	 Catch:{ Exception -> 0x00cb, all -> 0x00c6 }
        r8 = r8.length();	 Catch:{ Exception -> 0x00cb, all -> 0x00c6 }
        r10 = (r8 > r2 ? 1 : (r8 == r2 ? 0 : -1));
        if (r10 >= 0) goto L_0x0077;
    L_0x005a:
        r0 = r12.listener;	 Catch:{ Exception -> 0x00cb, all -> 0x00c6 }
        r0.fileRotated();	 Catch:{ Exception -> 0x00cb, all -> 0x00c6 }
        r0 = new java.io.RandomAccessFile;	 Catch:{ FileNotFoundException -> 0x006e }
        r8 = r12.file;	 Catch:{ FileNotFoundException -> 0x006e }
        r9 = "r";
        r0.<init>(r8, r9);	 Catch:{ FileNotFoundException -> 0x006e }
        org.apache.commons.io.IOUtils.closeQuietly(r1);	 Catch:{ FileNotFoundException -> 0x00bf }
        r1 = r0;
        r2 = r4;
        goto L_0x0046;
    L_0x006e:
        ...
        r0 = r1;
    L_0x0070:
        r1 = r12.listener;	 Catch:{ Exception -> 0x0042 }
    ...
    L_0x007b:
        r2 = r12.readLines(r1);	 Catch:{ Exception -> 0x00cb, all -> 0x00c6 }
        r6 = java.lang.System.currentTimeMillis();	 Catch:{ Exception -> 0x00cb, all -> 0x00c6 }
    L_0x0083:
        r0 = r12.reOpen;	 Catch:{ Exception -> 0x00cb, all -> 0x00c6 }
        if (r0 == 0) goto L_0x008a;
    L_0x0087:
        org.apache.commons.io.IOUtils.closeQuietly(r1);	 Catch:{ Exception -> 0x00cb, all -> 0x00c6 }
    L_0x008a:
        r8 = r12.delayMillis;	 Catch:{ InterruptedException -> 0x00c2 }
        java.lang.Thread.sleep(r8);	 Catch:{ InterruptedException -> 0x00c2 }
    L_0x008f:
        r0 = r12.run;	 Catch:{ Exception -> 0x00cb, all -> 0x00c6 }
    ...
    L_0x0093:
        ...
        if (r0 == 0) goto L_0x0046;
    L_0x0097:
        r0 = new java.io.RandomAccessFile;	 Catch:{ Exception -> 0x00cb, all -> 0x00c6 }
        r8 = r12.file;	 Catch:{ Exception -> 0x00cb, all -> 0x00c6 }
        r9 = "r";
        r0.<init>(r8, r9);	 Catch:{ Exception -> 0x00cb, all -> 0x00c6 }
        r0.seek(r2);	 Catch:{ Exception -> 0x0042 }
        r1 = r0;
        goto L_0x0046;
    L_0x00a5:
    ...
    L_0x00a7:
        r2 = 0;
        r1.seek(r2);	 Catch:{ Exception -> 0x00cb, all -> 0x00c6 }
        r2 = r12.readLines(r1);	 Catch:{ Exception -> 0x00cb, all -> 0x00c6 }
        r6 = java.lang.System.currentTimeMillis();	 Catch:{ Exception -> 0x00cb, all -> 0x00c6 }
        goto L_0x0083;
    L_0x00b5:
