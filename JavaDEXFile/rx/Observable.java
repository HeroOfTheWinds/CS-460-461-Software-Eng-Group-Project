...
public class Observable<T> {
    ...
    class AnonymousClass14 implements Func1<Observable<? extends Notification<?>>, Observable<?>> {
        ...
        class C12021 implements Func1<Notification<?>, Void> {
            C12021() {
            }
        ...
        public Observable<?> call(Observable<? extends Notification<?>> observable) {
            return (Observable) this.val$notificationHandler.call(observable.map(new C12021()));
        }
    }
    ...
    class AnonymousClass15 implements Func1<Observable<? extends Notification<?>>, Observable<?>> {
        ...
        class C12031 implements Func1<Notification<?>, Void> {
            C12031() {
            }
        ...
        public Observable<?> call(Observable<? extends Notification<?>> observable) {
            return (Observable) this.val$notificationHandler.call(observable.map(new C12031()));
        }
    }
    ...
    class C12041 implements OnSubscribe<T> {
        C12041() {
        }
    ...
    class AnonymousClass24 implements Func1<Observable<? extends Notification<?>>, Observable<?>> {
        ...
        class C12051 implements Func1<Notification<?>, Throwable> {
            C12051() {
            }
        ...
        public Observable<?> call(Observable<? extends Notification<?>> observable) {
            return (Observable) this.val$notificationHandler.call(observable.map(new C12051()));
        }
    }
    ...
    class AnonymousClass25 implements Func1<Observable<? extends Notification<?>>, Observable<?>> {
        ...
        class C12061 implements Func1<Notification<?>, Throwable> {
            C12061() {
            }
        ...
        public Observable<?> call(Observable<? extends Notification<?>> observable) {
            return (Observable) this.val$notificationHandler.call(observable.map(new C12061()));
        }
    }
    ...
    class C12072 implements OnSubscribe<R> {
        final /* synthetic */ Operator val$operator;

        C12072(Operator operator) {
        ...
        public void call(Subscriber<? super R> subscriber) {
            ...
            try {
                subscriber2 = (Subscriber) Observable.hook.onLift(this.val$operator).call(subscriber);
                subscriber2.onStart();
    ...
    static final class C12083 implements Func2<T, T, Boolean> {
        C12083() {
        }
    ...
    static final class C12094 implements Func1<List<? extends Observable<?>>, Observable<?>[]> {
        C12094() {
        }
    ...
    class C12105 implements Func2<R, T, R> {
        final /* synthetic */ Action2 val$collector;

        C12105(Action2 action2) {
    ...
    class C12116 implements Func1<T, Boolean> {
    ...
    class C12127 implements OnSubscribe<T> {
    ...
    class C12138 implements Observer<T> {
        final /* synthetic */ Action0 val$onCompleted;

        C12138(Action0 action0) {
    ...
    class C12149 implements Observer<T> {
        final /* synthetic */ Action1 val$onNotification;

        C12149(Action1 action1) {
    ...
    private static final class CountHolder {
        ...
        static final class C12151 implements Func2<Integer, Object, Integer> {
            C12151() {
            }
    ...
    private static final class CountLongHolder {
        ...
        static final class C12161 implements Func2<Long, Object, Long> {
            C12161() {
            }
    ...
    private static final class EmptyHolder {
        ...
        static final class C12171 implements OnSubscribe<Object> {
            C12171() {
            }
        ...
        static {
            INSTANCE = Observable.create(new C12171());
        }
    ...
    private static class NeverObservable<T> extends Observable<T> {
        ...
        class C12181 implements OnSubscribe<T> {
            C12181() {
            }
    ...
    private static class ThrowObservable<T> extends Observable<T> {
        ...
        class C12191 implements OnSubscribe<T> {
    ...
    public static <T> Observable<Boolean> sequenceEqual(Observable<? extends T> observable, Observable<? extends T> observable2) {
        return sequenceEqual(observable, observable2, new C12083());
    }
    ...
    public static <R> Observable<R> zip(Observable<? extends Observable<?>> observable, FuncN<? extends R> funcN) {
        return observable.toList().map(new C12094()).lift(new OperatorZip((FuncN) funcN));
    }
    ...
    public final <R> Observable<R> collect(Func0<R> func0, Action2<R, ? super T> action2) {
        return lift(new OperatorScan((Func0) func0, new C12105(action2))).last();
    }
    ...
    public final Observable<T> defaultIfEmpty(T t) {
        return switchIfEmpty(create(new C12127(t)));
    }
    ...
    public final Observable<T> doOnCompleted(Action0 action0) {
        return lift(new OperatorDoOnEach(new C12138(action0)));
    }
    ...
    public final Observable<T> doOnEach(Action1<Notification<? super T>> action1) {
        return lift(new OperatorDoOnEach(new C12149(action1)));
    }
    ...
    public final Observable<T> doOnNext(Action1<? super T> action1) {
        return lift(new OperatorDoOnEach(new AnonymousClass11(action1)));
    }
    ...
    public final Observable<T> doOnTerminate(Action0 action0) {
        return lift(new OperatorDoOnEach(new AnonymousClass12(action0)));
    }
    ...
    public final <R> Observable<R> lift(Operator<? extends R, ? super T> operator) {
        return new Observable(new C12072(operator));
    }
    ...
    public final <R> Observable<R> ofType(Class<R> cls) {
        return filter(new AnonymousClass13(cls)).cast(cls);
    }
    ...
    public final Observable<T> repeatWhen(Func1<? super Observable<? extends Void>, ? extends Observable<?>> func1) {
        return OnSubscribeRedo.repeat(this, new AnonymousClass15(func1));
    }

    public final Observable<T> repeatWhen(Func1<? super Observable<? extends Void>, ? extends Observable<?>> func1, Scheduler scheduler) {
        return OnSubscribeRedo.repeat(this, new AnonymousClass14(func1), scheduler);
    }
    ...
    public final <R> Observable<R> replay(Func1<? super Observable<T>, ? extends Observable<R>> func1, int i) {
        return OperatorReplay.multicastSelector(new AnonymousClass17(i), func1);
    }
    ...
    public final <R> Observable<R> replay(Func1<? super Observable<T>, ? extends Observable<R>> func1, int i, long j, TimeUnit timeUnit, Scheduler scheduler) {
        if (i >= 0) {
            return OperatorReplay.multicastSelector(new AnonymousClass18(i, j, timeUnit, scheduler), func1);
        }
    ...
    public final <R> Observable<R> replay(Func1<? super Observable<T>, ? extends Observable<R>> func1, int i, Scheduler scheduler) {
        return OperatorReplay.multicastSelector(new AnonymousClass19(i), new AnonymousClass20(func1, scheduler));
    }
    ...
    public final <R> Observable<R> replay(Func1<? super Observable<T>, ? extends Observable<R>> func1, long j, TimeUnit timeUnit, Scheduler scheduler) {
        return OperatorReplay.multicastSelector(new AnonymousClass21(j, timeUnit, scheduler), func1);
    }
    ...
    public final <R> Observable<R> replay(Func1<? super Observable<T>, ? extends Observable<R>> func1, Scheduler scheduler) {
        ...
        }, new AnonymousClass23(func1, scheduler));
    }
    ...
    public final Observable<T> retryWhen(Func1<? super Observable<? extends Throwable>, ? extends Observable<?>> func1) {
        return OnSubscribeRedo.retry(this, new AnonymousClass24(func1));
    }
    ...
    public final Observable<T> retryWhen(Func1<? super Observable<? extends Throwable>, ? extends Observable<?>> func1, Scheduler scheduler) {
        return OnSubscribeRedo.retry(this, new AnonymousClass25(func1), scheduler);
    }
    ...
    public final Subscription subscribe(Observer<? super T> observer) {
        return observer instanceof Subscriber ? subscribe((Subscriber) observer) : subscribe(new AnonymousClass30(observer));
    }
    ...
    public final Subscription subscribe(Action1<? super T> action1) {
        if (action1 != null) {
            return subscribe(new AnonymousClass27(action1));
        }
    ...
    public final Subscription subscribe(Action1<? super T> action1, Action1<Throwable> action12) {
        if (action1 == null) {
            ...
            return subscribe(new AnonymousClass28(action12, action1));
        } else {
    ...
    public final Subscription subscribe(Action1<? super T> action1, Action1<Throwable> action12, Action0 action0) {
        if (action1 == null) {
            ...
            return subscribe(new AnonymousClass29(action0, action12, action1));
        } else {
