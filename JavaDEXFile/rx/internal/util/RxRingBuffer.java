...
public class RxRingBuffer implements Subscription {
    ...
    static final class C14481 extends ObjectPool<Queue<Object>> {
        C14481() {
        }
    ...
    static final class C14492 extends ObjectPool<Queue<Object>> {
        C14492() {
        }
    ...
    static {
        ...
        SIZE = _size;
        SPSC_POOL = new C14481();
        SPMC_POOL = new C14492();
    }
