...
public final class IndexedRingBuffer<E> implements Subscription {
    ...
    static final class C14451 extends ObjectPool<IndexedRingBuffer<?>> {
        C14451() {
        }
    ...
    private int forEach(Func1<? super E, Boolean> func1, int i, int i2) {
        ...
        while (elementSection != null) {
            ...
            while (i6 < SIZE) {
                ...
                Object obj = elementSection.array.get(i6);
    ...
    public int forEach(Func1<? super E, Boolean> func1, int i) {
        ...
        return (i <= 0 || forEach != this.index.get()) ? forEach == this.index.get() ? 0 : forEach : forEach(func1, 0, i);
    }
