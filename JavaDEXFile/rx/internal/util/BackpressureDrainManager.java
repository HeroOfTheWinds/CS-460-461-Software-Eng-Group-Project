...
public final class BackpressureDrainManager extends AtomicLong implements Producer {
    ...
    L_0x0010:
        ...
        monitor-exit(r14);	 Catch:{ all -> 0x003b }
        r0 = r14.get();
        r10 = r14.actual;	 Catch:{ all -> 0x0061 }
    L_0x001c:
        r5 = r4;
    L_0x001d:
    ...
    L_0x0042:
        monitor-enter(r14);	 Catch:{ all -> 0x0061 }
    ...
    L_0x0058:
        r0 = 0;
        r14.emitting = r0;	 Catch:{ all -> 0x005d }
        monitor-exit(r14);	 Catch:{ all -> 0x005d }
        goto L_0x000f;
    L_0x005d:
        r0 = move-exception;
        r4 = r3;
    ...
    L_0x0061:
        ...
        goto L_0x0033;
    L_0x0063:
        r8 = r10.poll();	 Catch:{ all -> 0x0061 }
        if (r8 == 0) goto L_0x0042;
    L_0x0069:
        r8 = r10.accept(r8);	 Catch:{ all -> 0x0061 }
