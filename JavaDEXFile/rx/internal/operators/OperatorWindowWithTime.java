...
public final class OperatorWindowWithTime<T> implements Operator<Observable<T>, T> {
    ...
    final class ExactSubscriber extends Subscriber<T> {
        ...
        class C14281 implements Action0 {
            ...
            C14281(OperatorWindowWithTime operatorWindowWithTime) {
        ...
        class C14292 implements Action0 {
            C14292() {
            }
        ...
        public ExactSubscriber(Subscriber<? super Observable<T>> subscriber, Worker worker) {
            ...
            subscriber.add(Subscriptions.create(new C14281(OperatorWindowWithTime.this)));
        }
        ...
        void scheduleExact() {
            this.worker.schedulePeriodically(new C14292(), 0, OperatorWindowWithTime.this.timespan, OperatorWindowWithTime.this.unit);
        }
    }
    ...
    final class InexactSubscriber extends Subscriber<T> {
        ...
        class C14312 implements Action0 {
            ...
            C14312(CountedSerializedSubject countedSerializedSubject) {
        ...
        void scheduleChunk() {
            this.worker.schedulePeriodically(new C14301(), OperatorWindowWithTime.this.timeshift, OperatorWindowWithTime.this.timeshift, OperatorWindowWithTime.this.unit);
        }
        ...
        void startNewChunk() {
            ...
            synchronized (this.guard) {
                ...
                try {
                    ...
                    this.worker.schedule(new C14312(createCountedSerializedSubject), OperatorWindowWithTime.this.timespan, OperatorWindowWithTime.this.unit);
                } catch (Throwable th) {
                    onError(th);
                }
            }
