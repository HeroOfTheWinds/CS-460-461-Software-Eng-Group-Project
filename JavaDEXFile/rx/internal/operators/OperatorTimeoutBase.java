...
class OperatorTimeoutBase<T> implements Operator<T, T> {
    ...
    static final class TimeoutSubscriber<T> extends Subscriber<T> {
        ...
        public void onTimeout(long j) {
            ...
            Subscription c14111 = new C14111();
            this.other.unsafeSubscribe(c14111);
            this.serial.set(c14111);
        }
    ...
    public Subscriber<? super T> call(Subscriber<? super T> subscriber) {
        ...
        Subscriber<? super T> timeoutSubscriber = new TimeoutSubscriber(serializedSubscriber, this.timeoutStub, serialSubscription, this.other, createWorker);
