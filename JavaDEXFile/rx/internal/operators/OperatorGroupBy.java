...
public final class OperatorGroupBy<T, K, V> implements Operator<GroupedObservable<K, V>, T> {
    ...
    class C13361 implements Action0 {
        final /* synthetic */ GroupBySubscriber val$parent;

        C13361(GroupBySubscriber groupBySubscriber) {
    ...
    public static final class GroupBySubscriber<T, K, V> extends Subscriber<T> {
        ...
        public GroupBySubscriber(Subscriber<? super GroupedObservable<K, V>> subscriber, Func1<? super T, ? extends K> func1, Func1<? super T, ? extends V> func12, int i, boolean z) {
            ...
            this.f910s = new ProducerArbiter();
            this.f910s.request((long) i);
        ...
        public void setProducer(Producer producer) {
            this.f910s.setProducer(producer);
        }
    }
    ...
    public Subscriber<? super T> call(Subscriber<? super GroupedObservable<K, V>> subscriber) {
        Subscriber groupBySubscriber = new GroupBySubscriber(subscriber, this.keySelector, this.valueSelector, this.bufferSize, this.delayError);
        subscriber.add(Subscriptions.create(new C13361(groupBySubscriber)));
