...
public final class OperatorWindowWithStartEndObservable<T, U, V> implements Operator<Observable<T>, T> {
    ...
    class C14261 extends Subscriber<U> {
        ...
        C14261(SourceSubscriber sourceSubscriber) {
    ...
    final class SourceSubscriber extends Subscriber<T> {
        ...
        class C14271 extends Subscriber<V> {
            boolean once;
            final /* synthetic */ SerializedSubject val$s;

            C14271(SerializedSubject serializedSubject) {
        ...
        void beginWindow(U u) {
            ...
            synchronized (this.guard) {
                ...
                try {
                    ...
                    Object c14271 = new C14271(createSerializedSubject);
                    this.csub.add(c14271);
                    observable.unsafeSubscribe(c14271);
                } catch (Throwable th) {
                    onError(th);
                }
            }
    ...
    public Subscriber<? super T> call(Subscriber<? super Observable<T>> subscriber) {
        ...
        Object c14261 = new C14261(sourceSubscriber);
        compositeSubscription.add(sourceSubscriber);
        compositeSubscription.add(c14261);
        this.windowOpenings.unsafeSubscribe(c14261);
