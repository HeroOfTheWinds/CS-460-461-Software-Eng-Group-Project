...
public final class OperatorSequenceEqual {
    ...
    static final class C13761 implements Func1<T, Object> {
        C13761() {
        }
    ...
    static final class C13772 implements Func2<Object, Object, Boolean> {
    ...
    static <T> Observable<Object> materializeLite(Observable<T> observable) {
        return Observable.concat(observable.map(new C13761()), Observable.just(LOCAL_ONCOMPLETED));
    }
    ...
    public static <T> Observable<Boolean> sequenceEqual(Observable<? extends T> observable, Observable<? extends T> observable2, Func2<? super T, ? super T, Boolean> func2) {
        return Observable.zip(materializeLite(observable), materializeLite(observable2), new C13772(func2)).all(UtilityFunctions.identity());
    }
}
