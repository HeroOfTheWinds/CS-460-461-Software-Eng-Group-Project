...
public final class OperatorDebounceWithTime<T> implements Operator<T, T> {
    ...
    class C13191 extends Subscriber<T> {
        ...
        class C13181 implements Action0 {
            ...
            public void call() {
                C13191.this.state.emit(this.val$index, C13191.this.val$s, C13191.this.self);
            }
        }

        C13191(Subscriber subscriber, SerialSubscription serialSubscription, Worker worker, SerializedSubscriber serializedSubscriber) {
        ...
        public void onNext(T t) {
            this.val$ssub.set(this.val$worker.schedule(new C13181(this.state.next(t)), OperatorDebounceWithTime.this.timeout, OperatorDebounceWithTime.this.unit));
        }
    ...
    public Subscriber<? super T> call(Subscriber<? super T> subscriber) {
        ...
        return new C13191(subscriber, serialSubscription, createWorker, serializedSubscriber);
    }
}
