...
public final class BlockingOperatorToFuture {
    ...
    static final class C12661 extends Subscriber<T> {
        ...
        C12661(CountDownLatch countDownLatch, AtomicReference atomicReference, AtomicReference atomicReference2) {
    ...
    static final class C12672 implements Future<T> {
        ...
        C12672(CountDownLatch countDownLatch, Subscription subscription, AtomicReference atomicReference, AtomicReference atomicReference2) {
            this.val$finished = countDownLatch;
    ...
    public static <T> Future<T> toFuture(Observable<? extends T> observable) {
        ...
        return new C12672(countDownLatch, observable.single().subscribe(new C12661(countDownLatch, atomicReference2, atomicReference)), atomicReference2, atomicReference);
    }
}
