...
public final class OnSubscribeAmb<T> implements OnSubscribe<T> {
    ...
    class C12811 implements Action0 {
        final /* synthetic */ AtomicReference val$choice;
        final /* synthetic */ Selection val$selection;

        C12811(AtomicReference atomicReference, Selection selection) {
            this.val$choice = atomicReference;
            this.val$selection = selection;
        }

        public void call() {
            AmbSubscriber ambSubscriber = (AmbSubscriber) this.val$choice.get();
    ...
    class C12822 implements Producer {
        final /* synthetic */ AtomicReference val$choice;
        final /* synthetic */ Selection val$selection;

        C12822(AtomicReference atomicReference, Selection selection) {
            this.val$choice = atomicReference;
            this.val$selection = selection;
        }
        ...
        public void request(long j) {
            ...
            for (AmbSubscriber ambSubscriber2 : this.val$selection.ambSubscribers) {
                if (!ambSubscriber2.isUnsubscribed()) {
                    if (this.val$choice.get() == ambSubscriber2) {
    ...
    public void call(Subscriber<? super T> subscriber) {
        ...
        AtomicReference atomicReference = selection.choice;
        subscriber.add(Subscriptions.create(new C12811(atomicReference, selection)));
        ...
        subscriber.setProducer(new C12822(atomicReference, selection));
    }
}
