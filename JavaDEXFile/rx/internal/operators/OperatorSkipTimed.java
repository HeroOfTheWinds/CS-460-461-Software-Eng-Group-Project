...
public final class OperatorSkipTimed<T> implements Operator<T, T> {
    ...
    class C13831 implements Action0 {
        final /* synthetic */ AtomicBoolean val$gate;

        C13831(AtomicBoolean atomicBoolean) {
    ...
    class C13842 extends Subscriber<T> {
        final /* synthetic */ Subscriber val$child;
        final /* synthetic */ AtomicBoolean val$gate;

        C13842(Subscriber subscriber, AtomicBoolean atomicBoolean, Subscriber subscriber2) {
            this.val$gate = atomicBoolean;
    ...
    public Subscriber<? super T> call(Subscriber<? super T> subscriber) {
        ...
        createWorker.schedule(new C13831(atomicBoolean), this.time, this.unit);
        return new C13842(subscriber, atomicBoolean, subscriber);
    }
}
