...
public final class UnicastSubject<T> extends Subject<T, T> {
    ...
    static final class State<T> extends AtomicLong implements Producer, Observer<T>, Action0, OnSubscribe<T> {
        ...
        void replay() {
            ...
            r10 = this;
            monitor-enter(r10);
            r0 = r10.emitting;	 Catch:{ all -> 0x0074 }
            if (r0 == 0) goto L_0x000a;
        L_0x0005:
            r0 = 1;
            r10.missed = r0;	 Catch:{ all -> 0x0074 }
            monitor-exit(r10);	 Catch:{ all -> 0x0074 }
        L_0x0009:
            return;
        L_0x000a:
            r0 = 1;
            r10.emitting = r0;	 Catch:{ all -> 0x0074 }
            monitor-exit(r10);	 Catch:{ all -> 0x0074 }
            r8 = r10.queue;
        L_0x0010:
            r0 = r10.subscriber;
        ...
        L_0x005c:
            monitor-enter(r10);
            r0 = r10.missed;	 Catch:{ all -> 0x0071 }
        ...
        L_0x0069:
            r0 = 1;
            r10.caughtUp = r0;	 Catch:{ all -> 0x0071 }
        L_0x006c:
            r0 = 0;
            r10.emitting = r0;	 Catch:{ all -> 0x0071 }
        ...
        L_0x007b:
            r2 = r10.nl;
            r2 = r2.getValue(r9);
            r0.onNext(r2);	 Catch:{ Throwable -> 0x008e }
            r2 = 1;
            r2 = r4 - r2;
            r4 = 1;
            r4 = r4 + r6;
        ...
        L_0x009e:
            r0 = 0;
            r10.missed = r0;	 Catch:{ all -> 0x0071 }
            monitor-exit(r10);	 Catch:{ all -> 0x0071 }
            goto L_0x0010;
            */
