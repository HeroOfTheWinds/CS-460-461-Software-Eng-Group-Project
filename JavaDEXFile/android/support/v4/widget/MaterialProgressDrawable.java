...
class MaterialProgressDrawable extends Drawable implements Animatable {
    ...
    private static class Ring {
        ...
        public void setInsets(int i, int i2) {
            ...
            min = (this.mRingCenterRadius <= 0.0d || min < 0.0f) ? (float) Math.ceil((double) (this.mStrokeWidth / Default.HTTP_REQUEST_BACKOFF_MULT)) : (float) (((double) (min / Default.HTTP_REQUEST_BACKOFF_MULT)) - this.mRingCenterRadius);
