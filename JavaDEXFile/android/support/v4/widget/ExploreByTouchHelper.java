...
public abstract class ExploreByTouchHelper extends AccessibilityDelegateCompat {
    ...
    private boolean intersectVisibleToUser(android.graphics.Rect r4) {
        /*
        r3 = this;
    ...
    L_0x001c:
        ...
        r1 = android.support.v4.view.ViewCompat.getAlpha(r0);
        r2 = 0;
    ...
    L_0x0034:
        r0 = r3.mView;
        r1 = r3.mTempVisibleRect;
        r0 = r0.getLocalVisibleRect(r1);
        if (r0 == 0) goto L_0x0008;
    L_0x003e:
        r0 = r3.mTempVisibleRect;
        r0 = r4.intersect(r0);
        goto L_0x0009;
        */
