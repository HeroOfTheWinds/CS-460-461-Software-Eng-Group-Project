...
public class ActionBarDrawerToggle implements DrawerListener {
    ...
    public void onDrawerSlide(View view, float f) {
        ...
        this.mSlider.setPosition(f > 0.5f ? Math.max(position, Math.max(0.0f, f - 0.5f) * Default.HTTP_REQUEST_BACKOFF_MULT) : Math.min(position, f * Default.HTTP_REQUEST_BACKOFF_MULT));
    }
