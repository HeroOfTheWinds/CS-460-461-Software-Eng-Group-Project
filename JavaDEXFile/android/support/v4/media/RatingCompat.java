...
public final class RatingCompat implements Parcelable {
    ...
    public static RatingCompat newHeartRating(boolean z) {
        return new RatingCompat(RATING_HEART, z ? DefaultRetryPolicy.DEFAULT_BACKOFF_MULT : 0.0f);
    }
    ...
    public static RatingCompat newThumbRating(boolean z) {
        return new RatingCompat(RATING_THUMB_UP_DOWN, z ? DefaultRetryPolicy.DEFAULT_BACKOFF_MULT : 0.0f);
    }
    ...
    public boolean hasHeart() {
        return this.mRatingStyle == RATING_HEART && this.mRatingValue == DefaultRetryPolicy.DEFAULT_BACKOFF_MULT;
    }
    ...
    public boolean isThumbUp() {
        return this.mRatingStyle == RATING_THUMB_UP_DOWN && this.mRatingValue == DefaultRetryPolicy.DEFAULT_BACKOFF_MULT;
    }
