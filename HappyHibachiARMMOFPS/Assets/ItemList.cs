...
namespace Assets
{
    ...
    {
        private static Dictionary<byte, ItemDetails> items = new Dictionary<byte, ItemDetails>();
        ...
        public static void populateItemList()
        {
            ...
            items.Add(1, new ItemDetails("Landmine", "Assets\\Sprite Assets\\Landmine_WIP2.png"));
        }
